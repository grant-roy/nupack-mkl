...
int main(void)
{
	...
	printf("\n Double precision Helmholtz example on a sphere without poles has successfully PASSED\n");
...
FAILURE: printf("\nDouble precision Helmholtz example on a sphere without poles has FAILED to compute the solution...\n");
