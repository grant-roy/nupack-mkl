...
int main(void)
{
	...
	printf("\n Single precision Helmholtz example on a whole sphere has successfully PASSED\n");
...
FAILURE: printf("\nSingle precision Helmholtz example on a whole sphere has FAILED to compute the solution...\n");
