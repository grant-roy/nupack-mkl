...
int main(void)
{
	...
	printf("\n Double precision Helmholtz example in a spherical rectangle has successfully PASSED\n");
...
FAILURE: printf("\nDouble precision Helmholtz example in a spherical rectangle has FAILED to compute the solution...\n");
