...
/*       Get input data                                        */
      ...
      y = (MKL_Complex8 *)calloc( len_y, sizeof(MKL_Complex8) );
      ...
      lda=rmaxa;
      if( GetBandArrayC(in_file, &order, kl, ku, m, n, a, lda) != 0 ) {
...
/*       Print input data                                      */
      ...
      PrintBandArrayC(&order, FULLPRINT, kl, ku, m, n, a, lda, "A");

/*      Call CBLAS_CGBMV subroutine ( C Interface )            */

      cblas_cgbmv(order, trans, m, n, kl, ku, &alpha, a, lda,
                  x, incx, &beta, y, incy);
