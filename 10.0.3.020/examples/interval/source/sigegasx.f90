...
!
    ...
    READ ( INPUT, * ) N, NRHS
        ...
        READ ( INPUT, * ) (( B(I,J), I = 1, N ), J = 1, NRHS )
  ...
  400  FORMAT (/,' Division by a zero-containing interval encountered,',/,  &
                 '                    the interval Gauss method fails.',/)
  500  FORMAT (/,'   Enclosure of the solution column',I3,':',/)
  600  FORMAT (I3,A2,A,F8.4,',',F8.4,A)

    !--------------------------------------------------------------------------!

END PROGRAM SIGEGAS_EXAMPLE
