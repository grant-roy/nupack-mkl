...
PROGRAM SITRTRS_EXAMPLE
!
!       An example code for computing an outer interval estimate (enclosure)
!       of the solution set to an interval linear system of equations with
!       triangular matrix
!
!==============================================================================!
    ...
    TYPE(S_INTERVAL), ALLOCATABLE ::  A(:,:), B(:,:)
...
!
  ...
  100  FORMAT (/,'  **** SOLVING TRIANGULAR INTERVAL LINEAR SYSTEM ****',/)
  ...
  600  FORMAT ( I3,')', ' [', F10.6, ',', F10.6, ']' )

    !--------------------------------------------------------------------------!

END PROGRAM SITRTRS_EXAMPLE
