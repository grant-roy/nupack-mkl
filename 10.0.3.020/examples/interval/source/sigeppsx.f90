...
!
    ...
    !--------------------------------------------------------------------------!
        ...
        CALL SIGEPPS( TRANS,N,A,LDA,B,LDB,CMPT,MODE,ESTM,EPS,NITS,INFO )
