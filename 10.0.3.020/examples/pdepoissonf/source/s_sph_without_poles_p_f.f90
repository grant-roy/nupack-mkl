...
! Success message to print if everything is OK
	print *, ' Single precision Helmholtz example on a sphere without poles has successfully'
...
999 print *, 'Single precision Helmholtz example on a sphere without poles FAILED to compute the solution...'
