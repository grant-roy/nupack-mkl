...
!  sphere excluding poles using MKL Poisson Library
!
!*******************************************************************************
...
! Success message to print if everything is OK
	print *, ' Double precision Helmholtz example on a sphere without poles has successfully'
...
999 print *, 'Double precision Helmholtz example on a sphere without poles FAILED to compute the solution...'
