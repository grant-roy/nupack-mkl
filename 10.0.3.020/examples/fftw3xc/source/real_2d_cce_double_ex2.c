...
int main()  /* REAL_2D_CCE_DOUBLE_EX2 */
{
    /*
    ...
    */
    Desc_Handle = fftw_plan_dft_r2c_2d( n[0], n[1], x_in, (fftw_complex*)x_out, FFTW_ESTIMATE);
    ...
    */
    Desc_Handle = fftw_plan_dft_c2r_2d( n[0], n[1], (fftw_complex*)x_out, x_in, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    fftw_execute(Desc_Handle);
