...
int main()  /* REAL_1D_CCE_DOUBLE_EX1 */
{
    /*
    ...
    */
    Desc_Handle = fftw_plan_dft_r2c_1d( n, x_in, (fftw_complex*)x_in, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    ...
    */
    Desc_Handle = fftw_plan_dft_c2r_1d( n, (fftw_complex*)x_in, x_in, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    fftw_execute(Desc_Handle);
