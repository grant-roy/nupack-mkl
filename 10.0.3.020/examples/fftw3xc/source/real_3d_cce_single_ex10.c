...
!          program (C-interface)
!
!   Real-to-complex and complex-to-real 3D transform for single precision data
...
int main()  /* REAL_3D_CCE_SINGLE_EX10 */
{
    /*
    ...
    */
    ...
    if(LEGEND_PRINT) {
        ...
        printf(" DFTI_BACKWARD_SCALE = 1.0/(float)(n[0]*n[1]*n[2]) \n\n");
    }
    ...
    */
    Desc_Handle = fftwf_plan_dft_r2c( rank, n, x_in, x_out, FFTW_ESTIMATE);
    ...
    */
    Desc_Handle = fftwf_plan_dft_c2r( rank, n, x_out, x_in, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    fftwf_execute(Desc_Handle);
