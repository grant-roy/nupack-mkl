...
int main()  /* REAL_3D_CCE_DOUBLE_EX2 */
{
    /*
    ...
    */
    nn_in = (long)n[0] * (long)n[1] * (long)n[2];
    nn_out = ((long)n[0] * (long)n[1] * ((long)n[2]/2+1)) * 2;
    ...
    */
    Desc_Handle = fftw_plan_dft_r2c_3d( n[0], n[1], n[2], x_in, (fftw_complex*)x_out, FFTW_ESTIMATE);
    ...
    */
    Desc_Handle = fftw_plan_dft_c2r_3d( n[0], n[1], n[2], (fftw_complex*)x_out, x_in, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    fftw_execute(Desc_Handle);
