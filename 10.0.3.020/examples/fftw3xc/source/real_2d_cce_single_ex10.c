...
int main()  /* REAL_2D_CCE_SINGLE_EX10 */
{
    /*
    ...
    */
    ...
    x_in  = (float*)malloc(nn_out*sizeof(float));
    x_exp = (float*)malloc(nn_out*sizeof(float));
    /*
    /   initialize x_in and copy to expected x_exp
    */
    zero_init_s(x_in, nn_out);
    init_real_vectors_s(x_in, nn_out);
    cblas_scopy(nn_out, x_in, 1, x_exp, 1);

    /*
    /   Create Dfti descriptor for 2D single precision forward transform
    */
    Desc_Handle = fftwf_plan_dft_r2c(rank, n, x_in, (fftwf_complex*)x_in, FFTW_ESTIMATE);
    ...
    */
    Desc_Handle = fftwf_plan_dft_c2r(rank, n, (fftwf_complex*)x_in, x_in, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    fftwf_execute(Desc_Handle);
    ...
    */
    ...
    /   Result scaling
    */
    scaling_2d_f(x_in, Scale, n[0], n[1]);

    /*
    /   Check result
    */
    maxerr = check_result_2d_f(x_in, x_exp, n[0], n[1]);
   if(ACCURACY_PRINT)
        printf("\n ACCURACY = %g\n\n", maxerr);
