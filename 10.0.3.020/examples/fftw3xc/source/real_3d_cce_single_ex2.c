...
int main()  /* REAL_3D_CCE_SINGLE_EX2 */
{
    /*
    ...
    */
    Desc_Handle = fftwf_plan_dft_r2c_3d( n[0], n[1], n[2], x_in, x_out, FFTW_ESTIMATE);
    ...
    */
    Desc_Handle = fftwf_plan_dft_c2r_3d( n[0], n[1], n[2], x_out, x_in, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    fftwf_execute(Desc_Handle);
