...
int main()  /* R2R_1D_REDFT10_01_SINGLE_EX */
{
	/*
	/   TT input parameters 
	*/
	...
	if(LEGEND_PRINT) {  
		printf(" \n\n R2R_1D_REDFT10_01_SINGLE_EX           \n");
		printf(" Forward-Backward 1D real-to-real transform of type REDFT10/REDFT01\n");
		printf("(staggered cosine transform) for single precision data\n\n");
	}
	...
	*/
	Desc_Handle = fftwf_plan_r2r_1d( n, x_in, x_in, FFTW_REDFT10, FFTW_MEASURE);
	/*
	/   Compute TT
	*/
	...
	*/
	Desc_Handle = fftwf_plan_r2r_1d( n, x_in, x_in, FFTW_REDFT01, FFTW_MEASURE);
	/*
	/   Compute TT
	*/
	fftwf_execute(Desc_Handle);
