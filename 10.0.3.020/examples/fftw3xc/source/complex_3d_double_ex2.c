...
int main()  /* COMPLEX_3D_DOUBLE_EX2 */
{
    /*
    ...
    */
    ...
    init_multiple_columns_z(x_in, m, n[1], 0, N_MAX);
    ...
    */
    Desc_Handle = fftw_plan_dft(rank, n, &x_in, &x_out, FFTW_FORWARD, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    ...
    */
    Desc_Handle = fftw_plan_dft(rank, n, &x_out, &x_in, FFTW_BACKWARD, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    fftw_execute(Desc_Handle);
