...
!          program (C-interface)
!
!   Complex-to-complex 1D transform for single precision data inplace.
!
...
int main()  /* COMPLEX_1D_SINGLE_EX1 */
{
    /*
    ...
    */
    Desc_Handle = fftwf_plan_dft_1d( n, x_in, x_in , FFTW_FORWARD, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    ...
    */
    Desc_Handle = fftwf_plan_dft_1d( n, x_in , x_in, FFTW_BACKWARD, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    fftwf_execute(Desc_Handle);
