...
int main()  /* COMPLEX_1D_DOUBLE_EX2 */
{
    /*
    ...
    */
    ...
    x_out = (fftw_complex*)malloc(2*n*sizeof(double));
    ...
    */
    Desc_Handle = fftw_plan_dft_1d( n, x_in, x_out , FFTW_FORWARD, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    ...
    */
    Desc_Handle = fftw_plan_dft_1d( n, x_out , x_in, FFTW_BACKWARD, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    fftw_execute(Desc_Handle);
