...
int main()  /* REAL_1D_CCE_DOUBLE_EX10 */
{
    /*
    ...
    */
	nn = 2 * (n/2+1);
    x_in  = (double*)malloc(nn*sizeof(double));
    x_exp = (double*)malloc(nn*sizeof(double));
    /*
    ...
    */
    Desc_Handle = fftw_plan_dft_r2c( rank, &ni, x_in, (fftw_complex*)x_in, FFTW_ESTIMATE);
    ...
    */
    Desc_Handle = fftw_plan_dft_c2r(rank, &ni, (fftw_complex*)x_in, x_in, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    fftw_execute(Desc_Handle);
