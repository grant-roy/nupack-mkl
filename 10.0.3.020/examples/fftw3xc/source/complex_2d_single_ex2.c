...
int main()  /* COMPLEX_2D_SINGLE_EX2 */
{
    /*
    ...
    */
    ...
    fftwf_complex x_out[M_MAX][N_MAX];
	/* */
    ...
    */
    Desc_Handle = fftwf_plan_dft_2d( m, n, &x_in, &x_out, FFTW_FORWARD, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    ...
    */
    Desc_Handle = fftwf_plan_dft_2d( m, n, &x_out, &x_in, FFTW_BACKWARD, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    fftwf_execute(Desc_Handle);
