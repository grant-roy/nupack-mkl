...
int main()  /* COMPLEX_3D_SINGLE_EX1 */
{
    /*
    ...
    */
    ...
    init_multiple_columns_c(x_in, m, nn[1], 0, N_MAX);
    ...
    */
    Desc_Handle = fftwf_plan_dft_3d(nn[0], nn[1], nn[2], &x_in, &x_in, FFTW_FORWARD, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    ...
    */
    Desc_Handle = fftwf_plan_dft_3d(nn[0], nn[1], nn[2], &x_in, &x_in, FFTW_BACKWARD, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    fftwf_execute(Desc_Handle);
