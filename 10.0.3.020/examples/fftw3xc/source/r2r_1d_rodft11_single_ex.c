...
!          program (C-interface)
!
!   Real-to-real 1D transform of type RODFT11 (staggered2 sine transform)  
...
int main()  /* R2R_1D_RODFT11_SINGLE_EX */
{
	/*
	/   TT input parameters 
	*/
	...
	if(LEGEND_PRINT) {  
		printf(" \n\n R2R_1D_RODFT11_SINGLE_EX           \n");
		printf(" Forward-Backward 1D real-to-real transform of type RODFT11\n");
		printf("(staggered2 sine transform) for single precision data\n\n");
	}
	...
	*/
	Desc_Handle = fftwf_plan_r2r_1d( n, x_in, x_in, FFTW_RODFT11, FFTW_MEASURE);
	/*
	/   Compute TT
	*/
