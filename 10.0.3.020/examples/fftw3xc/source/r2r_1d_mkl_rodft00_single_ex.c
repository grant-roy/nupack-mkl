...
int main()  /* R2R_1D_MKL_RODFT00_SINGLE_EX */
{
	/*
	/   TT input parameters 
	*/
	...
	*/
	x_in  = (float*)malloc((n+2)*sizeof(float));
	x_exp = (float*)malloc((n+2)*sizeof(float));
	/*
	/   initialize x_in and copy to expected x_exp 
	*/
	zero_init_s(x_in, n+2);
	init_real_vectors_s(x_in, n+2);
	x_in[0] = 0.0;
	x_in[n+1] = 0.0;
	...
	/   FFTW_RODFT00 flags in MKL Technical User Notes for FFTW3.x
	*/
	Desc_Handle = fftwf_plan_r2r_1d( n, x_in, x_in, MKL_RODFT00, FFTW_MEASURE);
	/*
	/   Compute TT
	*/
