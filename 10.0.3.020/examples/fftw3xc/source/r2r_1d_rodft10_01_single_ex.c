...
int main()  /* R2R_1D_RODFT10_01_SINGLE_EX */
{
	/*
	/   TT input parameters 
	*/
	...
	if(LEGEND_PRINT) {  
		printf(" \n\n R2R_1D_RODFT10_01_SINGLE_EX           \n");
		printf(" Forward-Backward 1D real-to-real transform of type RODFT10/RODFT01\n");
		printf("(staggered sine transform) for single precision data\n\n");
	}
