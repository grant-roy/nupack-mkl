...
int main()  /* COMPLEX_2D_DOUBLE_EX2 */
{
    /*
    ...
    */
    Desc_Handle = fftw_plan_dft_2d( m, n, &x_in[0][0], &x_out[0][0], FFTW_FORWARD, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    ...
    */
    Desc_Handle = fftw_plan_dft_2d( m, n, &x_out[0][0], &x_in[0][0], FFTW_BACKWARD, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    fftw_execute(Desc_Handle);
