...
int main()  /* REAL_1D_CCE_SINGLE_EX10 */
{
    /*
    ...
    */
    ...
    x_exp = (float*)malloc(nn*sizeof(float));
    /*
    ...
    */
    Desc_Handle = fftwf_plan_dft_r2c(rank, &n, x_in, (fftw_complex*)x_in, FFTW_ESTIMATE);
    ...
    */
    Desc_Handle = fftwf_plan_dft_c2r(rank, &n, (fftw_complex*)x_in, x_in, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    fftwf_execute(Desc_Handle);
