...
int main()  /* R2R_1D_REDFT00_SINGLE_EX */
{
	/*
	/   TT input parameters 
	*/
	...
	if(LEGEND_PRINT) {  
		printf(" \n\n R2R_1D_REDFT00_SINGLE_EX           \n");
		printf(" Forward-Backward 1D real-to-real transform of type REDFT00\n");
		printf("(cosine transform) for single precision data\n\n");
	}
	...
	*/
	Desc_Handle = fftwf_plan_r2r_1d( n, x_in, x_in, FFTW_REDFT00, FFTW_MEASURE);
	/*
	/   Compute TT
	*/
