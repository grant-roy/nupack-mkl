...
int main()  /* REAL_1D_CCE_SINGLE_EX2 */
{
    /*
    ...
    */
    Desc_Handle = fftwf_plan_dft_r2c_1d( n, x_in, x_out, FFTW_ESTIMATE);
    ...
    */
    Desc_Handle = fftwf_plan_dft_c2r_1d( n, x_out, x_in, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    fftwf_execute(Desc_Handle);
