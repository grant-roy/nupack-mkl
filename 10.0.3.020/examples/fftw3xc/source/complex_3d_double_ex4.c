...
int main()  /* COMPLEX_3D_DOUBLE_EX4 */
{
    /*
    ...
    */
    ...
    fftw_complex x_out[M_MAX][N_MAX*2][K_MAX];
    long    m=5;
    long    n=4;
    long    k=3;
    long    first_index_in=0;
    long    step_in_m=2;
    long    step_in_n=2;
    long    step_in_k=2;
	/* */
    ...
    */
    Desc_Handle = fftw_plan_many_dft( rank, nn, multiple, &x_in[0][0][0], inembed, istride, idist,
	                      &x_out[0][0][0], onembed, ostride, odist, FFTW_FORWARD, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    ...
    */
    Desc_Handle = fftw_plan_many_dft( rank, nn, multiple, &x_out[0][0][0], onembed, ostride, odist,
	               &x_in[0][0][0], inembed, istride, idist, FFTW_BACKWARD, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    fftw_execute(Desc_Handle);
