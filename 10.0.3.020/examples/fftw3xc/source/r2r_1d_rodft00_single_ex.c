...
!          program (C-interface)
!
!   Real-to-real 1D transform of type RODFTOO (sine transform) for single 
!   precision data
!*********************************************************************************/
...
int main()  /* R2R_1D_RODFT00_SINGLE_EX */
{
	/*
	/   TT input parameters 
	*/
	...
	if(LEGEND_PRINT) {  
		printf(" \n\n R2R_1D_RODFT00_SINGLE_EX           \n");
		printf(" Forward-Backward 1D real-to-real transform of type RODFT00\n");
		printf("(sine transform) for single precision data\n\n");
	}
	...
	*/
	Desc_Handle = fftwf_plan_r2r_1d( n, x_in, x_in, FFTW_RODFT00, FFTW_MEASURE);
	/*
	/   Compute TT
	*/
