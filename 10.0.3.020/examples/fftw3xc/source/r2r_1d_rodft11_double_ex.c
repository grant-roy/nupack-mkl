...
int main()  /* R2R_1D_RODFT11_DOUBLE_EX */
{
	/*
	/   TT input parameters 
	*/
	...
	if(LEGEND_PRINT) {  
		printf(" \n\n R2R_1D_RODFT11_DOUBLE_EX           \n");
		printf(" Forward-Backward 1D real-to-real transform of type RODFT11\n");
		printf("(staggered2 sine transform) for double precision data\n\n");
	}
	/*
	...
	*/
	Desc_Handle = fftw_plan_r2r_1d( n, x_in, x_in, FFTW_RODFT11, FFTW_MEASURE);
	/*
	/   Compute TT
	*/
