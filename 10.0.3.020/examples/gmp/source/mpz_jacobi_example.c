...
/*                                                                   */
	   ...
	   char str2[] = "3521";
/*                                                                   */
/*     Initialization of all multiple precision variables ( a, b )   */
...
/*                                                                   */
/*  Call mpz_jacobi to set Jacobi_symbol to the Jacobi symbol (a/b)  */
/*                                                                   */
       Jacobi_symbol = mpz_jacobi ( a, b );
/*                                                                   */
/*     Printing of result ( Jacobi symbol ) in the form of           */
/* Jacobi_symbol = 1                                                 */
/*                                                                   */
       printf ( " Jacobi_symbol = %d\n", Jacobi_symbol );
/*                                                                   */
/*             Free the space occupied by a, b                       */
/*                                                                   */
       mpz_clear ( a );
       mpz_clear ( b );
       return 0;
