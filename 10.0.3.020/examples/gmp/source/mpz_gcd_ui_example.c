...
/*                                                                   */
/*                  Call mpz_gcd_ui                                  */
/*     to set rop to the greatest common divisor of op1 and op2      */
/*                                                                   */
       n = mpz_gcd_ui ( rop, op1, op2 );
/*                                                                   */
/*      Call mpz_get_str to convert rop to a string of digits        */
/*  in base 10 and printing of result ( rop and n ) in the form of   */
/* rop =  121                                                        */
/* n = 121                                                           */
/*                                                                   */
