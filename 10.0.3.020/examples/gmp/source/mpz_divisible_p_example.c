...
/*                                                                   */
/*  Initialization of all multiple precision variables ( n, d )      */
...
/*                                                                   */
/* Call mpz_divisible_p to set p to 0 if n is exactly divisible by d */
/*                                                                   */
       p = mpz_divisible_p( n, d);
/*                                                                   */
...
/*                                                                   */
       printf( " p = %d\n", p );
/*                                                                   */
/*             Free the space occupied by n, d                       */
/*                                                                   */
       mpz_clear ( n );
       mpz_clear ( d );
       return 0;
