...
/*                                                                   */
	   mpz_init ( op );
/*                                                                   */
/*       Call mpz_set_str to set op = 4294967295                     */
/*                                                                   */
	   mpz_set_str ( op, str1, 10 );
/*                                                                   */
/*     mpz_fits_ulong_p return 1 if the value of op fits in          */
/*                  an unsigned long int. Otherwise, return zero.    */
/*                                                                   */

	   n = mpz_fits_ulong_p ( op );
/*                                                                   */
