...
/* (rop,op1) and assignment of data to entrance variables(op1,op2)   */
/*                                                                   */
        mpz_init ( rop );
	    mpz_init ( op1 );
/*                                                                   */
/*     Call mpz_set to set op1 = 18446744073709551616                */
/*                                                                   */
	    mpz_set_str ( op1, str, 10);
        op2 = 1;
/*                                                    op2            */
/*             Call mpz_mul_2exp to set rop to op1 * 2               */
/*                                                                   */
        mpz_mul_2exp( rop, op1, op2);
/*                                                                   */
/*  Call mpz_get_str to convert rop to a string of digits in base 10 */
/*        and printing of result ( rop ) in the form of              */
/* rop = 36893488147419103232                                        */
/*                                                                   */
