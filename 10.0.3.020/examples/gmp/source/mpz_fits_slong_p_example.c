...
/*                                                                   */
	   mpz_init ( op );
/*                                                                   */
/*       Call mpz_set_str to set op = 2147483647                     */
/*                                                                   */
	   mpz_set_str ( op, str1, 10 );
/*                                                                   */
/*     mpz_fits_slong_p return 1 if the value of op fits in          */
/*                  an signed long int. Otherwise, return zero.      */
/*                                                                   */

	   n = mpz_fits_slong_p ( op );
/*                                                                   */
