...
/*                                                                   */
/*     Initialization of all multiple precision variables ( b )      */
/*     and assignment of data to entrance variables ( a, b )         */
/*                                                                   */
       mpz_init ( b );
/*                                                                   */
/*     Call mpz_set_str to set b = 672749994932560009201             */
/*                                                                   */
	   mpz_set_str ( b, str1, 10 );
	   a = 3521;
/*                                                                   */
/*  Call mpz_ui_kronecker to set Kronecker_symbol                    */
/*                        to the Kronecker symbol (a/b)              */
/*                                                                   */
       Kronecker_symbol = mpz_ui_kronecker ( a, b );
/*                                                                   */
