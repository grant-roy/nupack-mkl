...
!*******************************************************************************
      ...
      MaxRMS=0.0
      do i=1,VEC_LEN
            dA1(i)=VML_DSUB_BEG+((VML_DSUB_END-VML_DSUB_BEG)*i)/VEC_LEN
            dA2(i)=VML_DSUB_END-((VML_DSUB_END-VML_DSUB_BEG)*i)/VEC_LEN
            dB1(i)=0.0
            dB2(i)=dA1(i)-dA2(i)
      end do

      call VDSUB(VEC_LEN,dA1,dA2,dB1)

      print *,"vdSub test/example program"
      print *,""
      print *,""
      print *,"           Argument                     vdSub         ", &
     &        "             -"
      print *,"======================================================", &
     &        "========================"
      do i=1,VEC_LEN
