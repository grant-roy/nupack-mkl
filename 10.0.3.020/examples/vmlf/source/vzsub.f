...
!*******************************************************************************
      ...
      do i=1,VEC_LEN
            zA1(i)=CMPLX(VML_DSUB_BEG+((VML_DSUB_END-VML_DSUB_BEG)*i)/  &
     &      VEC_LEN,VML_DSUB_END-((VML_DSUB_END-VML_DSUB_BEG)*i)/       &
     &      VEC_LEN)
            zA2(i)=CMPLX(VML_DSUB_BEG+((VML_DSUB_END-VML_DSUB_BEG)*i)/  &
     &      VEC_LEN,VML_DSUB_END-((VML_DSUB_END-VML_DSUB_BEG)*i)/       &
     &      VEC_LEN)
            zB1(i)=0.0
      end do

      call VZSUB(VEC_LEN,zA1,zA2,zB1)
