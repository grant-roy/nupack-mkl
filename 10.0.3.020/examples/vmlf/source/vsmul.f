...
!*******************************************************************************
      ...
      MaxRMS=0.0
      do i=1,VEC_LEN
            sA1(i)=VML_SMUL_BEG+((VML_SMUL_END-VML_SMUL_BEG)*i)/VEC_LEN
            sA2(i)=VML_SMUL_BEG+((VML_SMUL_END-VML_SMUL_BEG)*i)/VEC_LEN
            sB1(i)=0.0
            sB2(i)=sA1(i)*sA2(i)
      end do

      call VSMUL(VEC_LEN,sA1,sA2,sB1)

      print *,"vsMul test/example program"
      print *,""
      print *,""
      print *,"           Argument                     vsMul         ", &
     &        "             *"
      print *,"======================================================", &
     &        "========================"
      do i=1,VEC_LEN
