...
!*******************************************************************************
      ...
      MaxRMS=0.0
      do i=1,VEC_LEN
            dA1(i)=VML_DADD_BEG+((VML_DADD_END-VML_DADD_BEG)*i)/VEC_LEN
            dA2(i)=VML_DADD_BEG+((VML_DADD_END-VML_DADD_BEG)*i)/VEC_LEN
            dB1(i)=0.0
            dB2(i)=dA1(i)+dA2(i)
      end do

      call VDADD(VEC_LEN,dA1,dA2,dB1)

      print *,"vdAdd test/example program"
      print *,""
      print *,""
      print *,"           Argument                     vdAdd         ", &
     &        "             +"
      print *,"======================================================", &
     &        "========================"
      do i=1,VEC_LEN
