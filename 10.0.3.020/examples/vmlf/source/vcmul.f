...
!*******************************************************************************
      ...
      do i=1,VEC_LEN
            cA1(i)=CMPLX(VML_SMUL_BEG+((VML_SMUL_END-VML_SMUL_BEG)*i)/  &
     &      VEC_LEN,VML_SMUL_END-((VML_SMUL_END-VML_SMUL_BEG)*i)/       &
     &      VEC_LEN)
            cA2(i)=CMPLX(VML_SMUL_BEG+((VML_SMUL_END-VML_SMUL_BEG)*i)/  &
     &      VEC_LEN,VML_SMUL_END-((VML_SMUL_END-VML_SMUL_BEG)*i)/       &
     &      VEC_LEN)
            cB1(i)=0.0
      end do

      call VCMUL(VEC_LEN,cA1,cA2,cB1)
