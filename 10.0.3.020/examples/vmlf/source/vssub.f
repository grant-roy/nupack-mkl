...
!*******************************************************************************
      ...
      MaxRMS=0.0
      do i=1,VEC_LEN
            sA1(i)=VML_SSUB_BEG+((VML_SSUB_END-VML_SSUB_BEG)*i)/VEC_LEN
            sA2(i)=VML_SSUB_END-((VML_SSUB_END-VML_SSUB_BEG)*i)/VEC_LEN
            sB1(i)=0.0
            sB2(i)=sA1(i)-sA2(i)
      end do

      call VSSUB(VEC_LEN,sA1,sA2,sB1)

      print *,"vsSub test/example program"
      print *,""
      print *,""
      print *,"           Argument                     vsSub         ", &
     &        "             -"
      print *,"======================================================", &
     &        "========================"
      do i=1,VEC_LEN
