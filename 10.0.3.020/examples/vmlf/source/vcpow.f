...
!*******************************************************************************
      ...
      do i=1,VEC_LEN
            cA1(i)=CMPLX(VML_SPOW_BEG+((VML_SPOW_END-VML_SPOW_BEG)*i)/  &
     &      VEC_LEN,VML_SPOW_END-((VML_SPOW_END-VML_SPOW_BEG)*i)/       &
     &      VEC_LEN)
            cA2(i)=CMPLX(VML_SPOW_BEG+((VML_SPOW_END-VML_SPOW_BEG)*i)/  &
     &      VEC_LEN,VML_SPOW_END-((VML_SPOW_END-VML_SPOW_BEG)*i)/       &
     &      VEC_LEN)
            cB1(i)=0.0
      end do

      call VCPOW(VEC_LEN,cA1,cA2,cB1)
