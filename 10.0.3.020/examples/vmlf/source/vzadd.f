...
!*******************************************************************************
      ...
      do i=1,VEC_LEN
            zA1(i)=CMPLX(VML_DADD_BEG+((VML_DADD_END-VML_DADD_BEG)*i)/  &
     &      VEC_LEN,VML_DADD_END-((VML_DADD_END-VML_DADD_BEG)*i)/       &
     &      VEC_LEN)
            zA2(i)=CMPLX(VML_DADD_BEG+((VML_DADD_END-VML_DADD_BEG)*i)/  &
     &      VEC_LEN,VML_DADD_END-((VML_DADD_END-VML_DADD_BEG)*i)/       &
     &      VEC_LEN)
            zB1(i)=0.0
      end do

      call VZADD(VEC_LEN,zA1,zA2,zB1)
