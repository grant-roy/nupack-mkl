...
!*******************************************************************************
      ...
      do i=1,VEC_LEN
            cA1(i)=CMPLX(VML_SMULBYCONJ_BEG+((VML_SMULBYCONJ_END-       &
     &             VML_SMULBYCONJ_BEG)*i)/VEC_LEN,VML_SMULBYCONJ_END-   &
     &             ((VML_SMULBYCONJ_END-VML_SMULBYCONJ_BEG)*i)/VEC_LEN)
            cA2(i)=CMPLX(VML_SMULBYCONJ_BEG+((VML_SMULBYCONJ_END-       &
     &             VML_SMULBYCONJ_BEG)*i)/VEC_LEN,VML_SMULBYCONJ_END-   &
     &             ((VML_SMULBYCONJ_END-VML_SMULBYCONJ_BEG)*i)/VEC_LEN)
            cB1(i)=0.0
      end do

      call VCMULBYCONJ(VEC_LEN,cA1,cA2,cB1)
