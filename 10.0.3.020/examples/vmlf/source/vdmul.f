...
!*******************************************************************************
      ...
      MaxRMS=0.0
      do i=1,VEC_LEN
            dA1(i)=VML_DMUL_BEG+((VML_DMUL_END-VML_DMUL_BEG)*i)/VEC_LEN
            dA2(i)=VML_DMUL_BEG+((VML_DMUL_END-VML_DMUL_BEG)*i)/VEC_LEN
            dB1(i)=0.0
            dB2(i)=dA1(i)*dA2(i)
      end do

      call VDMUL(VEC_LEN,dA1,dA2,dB1)

      print *,"vdMUL test/example program"
      print *,""
      print *,""
      print *,"           Argument                     vdMul         ", &
     &        "             *"
      print *,"======================================================", &
     &        "========================"
      do i=1,VEC_LEN
