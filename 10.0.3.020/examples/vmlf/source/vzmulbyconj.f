...
!*******************************************************************************
      ...
      do i=1,VEC_LEN
            zA1(i)=CMPLX(VML_DMULBYCONJ_BEG+((VML_DMULBYCONJ_END-       &
     &             VML_DMULBYCONJ_BEG)*i)/VEC_LEN,VML_DMULBYCONJ_END-   &
     &             ((VML_DMULBYCONJ_END-VML_DMULBYCONJ_BEG)*i)/VEC_LEN)
            zA2(i)=CMPLX(VML_DMULBYCONJ_BEG+((VML_DMULBYCONJ_END-       &
     &             VML_DMULBYCONJ_BEG)*i)/VEC_LEN,VML_DMULBYCONJ_END-   &
     &             ((VML_DMULBYCONJ_END-VML_DMULBYCONJ_BEG)*i)/VEC_LEN)
            zB1(i)=0.0
      end do

      call VZMULBYCONJ(VEC_LEN,zA1,zA2,zB1)
