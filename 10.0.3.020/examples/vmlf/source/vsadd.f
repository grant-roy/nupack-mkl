...
!*******************************************************************************
      ...
      MaxRMS=0.0
      do i=1,VEC_LEN
            sA1(i)=VML_SADD_BEG+((VML_SADD_END-VML_SADD_BEG)*i)/VEC_LEN
            sA2(i)=VML_SADD_BEG+((VML_SADD_END-VML_SADD_BEG)*i)/VEC_LEN
            sB1(i)=0.0
            sB2(i)=sA1(i)+sA2(i)
      end do

      call VSADD(VEC_LEN,sA1,sA2,sB1)

      print *,"vsAdd test/example program"
      print *,""
      print *,""
      print *,"           Argument                     vsAdd         ", &
     &        "             +"
      print *,"======================================================", &
     &        "========================"
      do i=1,VEC_LEN
