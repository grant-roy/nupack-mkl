...
!*******************************************************************************
      ...
      do i=1,VEC_LEN
            zA1(i)=CMPLX(VML_DPOW_BEG+((VML_DPOW_END-VML_DPOW_BEG)*i)/  &
     &      VEC_LEN,VML_DPOW_END-((VML_DPOW_END-VML_DPOW_BEG)*i)/       &
     &      VEC_LEN)
            zA2(i)=CMPLX(VML_DPOW_BEG+((VML_DPOW_END-VML_DPOW_BEG)*i)/  &
     &      VEC_LEN,VML_DPOW_END-((VML_DPOW_END-VML_DPOW_BEG)*i)/       &
     &      VEC_LEN)
            zB1(i)=0.0
      end do

      call VZPOW(VEC_LEN,zA1,zA2,zB1)
