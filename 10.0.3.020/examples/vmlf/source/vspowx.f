...
!*******************************************************************************
      ...
      MaxRMS=0.0
      sA2=VML_SPOWX_BEG+(VML_SPOWX_END-VML_SPOWX_BEG)/2.0
      do i=1,VEC_LEN
            sA1(i)=VML_SPOWX_BEG+((VML_SPOWX_END-VML_SPOWX_BEG)*i)/     &
     &             VEC_LEN
            sB1(i)=0.0
            sB2(i)=sA1(i)**sA2
      end do

      call VSPOWX(VEC_LEN,sA1,sA2,sB1)
     ...
     &        "========================"
      do i=1,VEC_LEN
            print 10,sA1(i),sA2,sB1(i),sB2(i)
