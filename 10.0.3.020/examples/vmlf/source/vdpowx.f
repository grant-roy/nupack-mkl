...
!*******************************************************************************
      ...
      MaxRMS=0.0
      dA2=VML_DPOWX_BEG+(VML_DPOWX_END-VML_DPOWX_BEG)/2.0
      do i=1,VEC_LEN
            dA1(i)=VML_DPOWX_BEG+((VML_DPOWX_END-VML_DPOWX_BEG)*i)/     &
     &            VEC_LEN
            dB1(i)=0.0
            dB2(i)=dA1(i)**dA2
      end do

      call VDPOWX(VEC_LEN,dA1,dA2,dB1)
     ...
     &        "========================"
      do i=1,VEC_LEN
            print 10,dA1(i),dA2,dB1(i),dB2(i)
