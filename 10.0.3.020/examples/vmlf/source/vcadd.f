...
!*******************************************************************************
      ...
      do i=1,VEC_LEN
            cA1(i)=CMPLX(VML_SADD_BEG+((VML_SADD_END-VML_SADD_BEG)*i)/  &
     &      VEC_LEN,VML_SADD_END-((VML_SADD_END-VML_SADD_BEG)*i)/       &
     &      VEC_LEN)
            cA2(i)=CMPLX(VML_SADD_BEG+((VML_SADD_END-VML_SADD_BEG)*i)/  &
     &      VEC_LEN,VML_SADD_END-((VML_SADD_END-VML_SADD_BEG)*i)/       &
     &      VEC_LEN)
            cB1(i)=0.0
      end do

      call VCADD(VEC_LEN,cA1,cA2,cB1)
