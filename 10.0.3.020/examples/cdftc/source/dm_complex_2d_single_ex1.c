...
int main(int argc, char *argv[])  /* DM_COMPLEX_2D_SINGLE_EX1 */
{
    ...
    */
    x_in = (mkl_float_complex *)malloc(sizeof(mkl_float_complex)*m*n);
    x_exp = (mkl_float_complex *)malloc(sizeof(mkl_float_complex)*m*n);
	...
	*/
	...
	local=(mkl_float_complex*)malloc(size*sizeof(mkl_float_complex));
	work=(mkl_float_complex*)malloc(size*sizeof(mkl_float_complex));
