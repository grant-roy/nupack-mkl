...
!******************************************************************************/
      ...
      PROGRAM R2R_1D_MKL_RODFT00_DOUBLE_EX
...
!
      ...
      CALL DFFTW_PLAN_R2R_1D(FFTW_PLAN,N,IN,OUT,MKL_RODFT00)
...
!
      PRINT*,' Create FFTW plan for 1D real-to-real (sine) transform'
      CALL DFFTW_PLAN_R2R_1D(FFTW_PLAN,N,OUT,IN,MKL_RODFT00)
...
!
      PRINT*,' Check results'
      CALL CHECK_RESULT_D(IN,EXP_X,N+2,ERR)
      PRINT*,' Accuracy=',ERR
