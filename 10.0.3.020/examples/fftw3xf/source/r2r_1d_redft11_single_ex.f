...
!******************************************************************************/
      ...
      PROGRAM R2R_1D_REDFT11_SINGLE_EX
...
!
!     Create FFTW plan for 1D real-to-real (staggered2 cosine) transform
!
      PRINT*,'Create FFTW plan for 1D r2r (staggered2 cosine) transform'
      CALL SFFTW_PLAN_R2R_1D(FFTW_PLAN,N,IN,OUT,FFTW_REDFT11)

!
!     Compute 1D real-to-real (staggered2 cosine) transform
!
      PRINT*,' Compute 1D r2r (staggered2 cosine) transform'
...
!
      PRINT*,'Create FFTW plan for 1D r2r (staggered2 cosine) transform'
      CALL SFFTW_PLAN_R2R_1D(FFTW_PLAN,N,OUT,IN,FFTW_REDFT11)
