...
int main()  /* REAL_2D_EX10 */
{
    ...
    */
    nn = 2*(n/2+1)*m;
    x_in = (fftw_real*)malloc(n*m*sizeof(TYPE_PRECISION));
    x_exp = (fftw_real*)malloc(n*m*sizeof(TYPE_PRECISION));
    x_out = (fftw_complex*)malloc(nn*sizeof(TYPE_PRECISION));
    /*
    ...
    */
    Desc_Handle = rfftw2d_create_plan( m, n, FFTW_REAL_TO_COMPLEX, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    rfftwnd_threads_one_real_to_complex(1,Desc_Handle, x_in, x_out);
    ...
    */
    Desc_Handle = rfftw2d_create_plan( m, n, FFTW_COMPLEX_TO_REAL, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    rfftwnd_threads_one_complex_to_real(1,Desc_Handle, x_out, x_in);
