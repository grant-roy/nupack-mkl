...
int main()  /* COMPLEX_3D_EX11*/
{
    ...
    */
    ...
    /   Compute DFT
    */
    fftwnd_threads(1, Desc_Handle, multiple, x_in, istride, idist, x_in, 0, 0);
    ...
    */
    ...
    /   Compute DFT
    */
    fftwnd_threads(1, Desc_Handle, multiple, x_in, istride, idist, NULL, istride, 0);
