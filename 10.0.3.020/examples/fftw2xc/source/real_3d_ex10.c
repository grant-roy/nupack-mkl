...
int main()  /* REAL_3D_EX2 */
{
    ...
    */
    Desc_Handle = rfftw3d_create_plan( m, n, k, FFTW_REAL_TO_COMPLEX, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
    ...
    */
    Desc_Handle = rfftw3d_create_plan( m, n, k, FFTW_COMPLEX_TO_REAL, FFTW_ESTIMATE);
    /*
    /   Compute DFT
    */
