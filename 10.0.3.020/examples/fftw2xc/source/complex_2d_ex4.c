...
int main()  /* COMPLEX_2D_EX4 */
{
    ...
    */
    Desc_Handle = fftw2d_create_plan_specific( m, n, FFTW_FORWARD, FFTW_ESTIMATE,
...
/*    xx_in = (TYPE_PRECISION*)x_in;
    ...
    */
    Desc_Handle = fftw2d_create_plan_specific( m, n, FFTW_BACKWARD, FFTW_ESTIMATE,
