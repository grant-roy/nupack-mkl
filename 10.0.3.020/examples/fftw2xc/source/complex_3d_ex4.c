...
int main()  /* COMPLEX_3D_EX4 */
{
    ...
    */
    Desc_Handle = fftw3d_create_plan_specific( m, n, k, FFTW_FORWARD, FFTW_ESTIMATE,
    ...
    */
    Desc_Handle = fftw3d_create_plan_specific( m, n, k, FFTW_BACKWARD, FFTW_ESTIMATE,
