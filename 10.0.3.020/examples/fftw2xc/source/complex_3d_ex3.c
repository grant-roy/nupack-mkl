...
int main()  /* COMPLEX_3D_EX3 */
{
    ...
    */
    Desc_Handle = fftw3d_create_plan_specific( m, n, k, FFTW_FORWARD, FFTW_ESTIMATE | FFTW_IN_PLACE,
		                                     x_in, istride, NULL, 0);
...
/*    xx_in = (TYPE_PRECISION*)x_in;
    ...
    */
    Desc_Handle = fftw3d_create_plan_specific( m, n, k, FFTW_BACKWARD, FFTW_ESTIMATE | FFTW_IN_PLACE,
		                                     x_in, istride, NULL, 0);
    /*
    /   Compute DFT
    */
