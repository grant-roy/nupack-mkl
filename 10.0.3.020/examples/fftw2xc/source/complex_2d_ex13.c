...
int main()  /* COMPLEX_2D_EX1 */
{
    ...
    */
    ...
    if(LEGEND_PRINT) {
        ...
        printf(" DFTI_PLACEMENT      = DFTI_IN_INPLACE     \n");
    ...
    */
    Desc_Handle = fftw2d_create_plan( m, n, FFTW_FORWARD, FFTW_ESTIMATE | FFTW_IN_PLACE);
    /*
    /   Compute DFT
    */
    fftwnd_threads_one(1, Desc_Handle, &x_in[0][0], NULL);
    ...
    */
    Desc_Handle = fftw2d_create_plan( m, n, FFTW_BACKWARD, FFTW_ESTIMATE | FFTW_IN_PLACE);
    /*
    /   Compute DFT
    */
    fftwnd_threads_one(1, Desc_Handle, &x_in[0][0], NULL);
