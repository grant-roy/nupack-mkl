...
!           DFTI_PLACEMENT      = DFTI_OUT_OF_PLACE
...
int main()  /* COMPLEX_1D_EX6 */
{
    ...
    */
    ...
    if(LEGEND_PRINT) {
        ...
        printf(" DFTI_PLACEMENT      = DFTI_OUTOFPLACE   \n");
    ...
    */
    Desc_Handle = fftw_create_plan_specific( n, FFTW_FORWARD, FFTW_ESTIMATE,
    ...
    /   Compute DFT
    */
    fftw(Desc_Handle, multiple, x_in, istride, idist, x_out, ostride, odist);
...
/*	{
    ...
    */
    Desc_Handle = fftw_create_plan_specific( n, FFTW_BACKWARD, FFTW_ESTIMATE,
		                                     x_out, ostride, x_in, istride);
    /*
    /   Compute DFT
    */
    fftw(Desc_Handle, multiple, x_out, ostride, odist, x_in, istride, idist);
