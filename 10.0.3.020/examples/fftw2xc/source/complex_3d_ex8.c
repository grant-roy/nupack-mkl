...
int main()  /* COMPLEX_3D_EX8 */
{
    ...
    */
    Desc_Handle = fftwnd_create_plan_specific( rank, nn, FFTW_FORWARD, FFTW_ESTIMATE,
    ...
    */
    Desc_Handle = fftwnd_create_plan_specific( rank, nn, FFTW_BACKWARD, FFTW_ESTIMATE,
