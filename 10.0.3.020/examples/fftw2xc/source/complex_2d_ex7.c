...
int main()  /* COMPLEX_2D_EX7 */
{
    ...
    */
    Desc_Handle = fftwnd_create_plan_specific( rank, nn, FFTW_FORWARD, FFTW_ESTIMATE | FFTW_IN_PLACE,
		                                     x_in, istride, NULL, 0);
    /*
    /   Compute DFT
    */
    ...
    */
    Desc_Handle = fftwnd_create_plan_specific( rank, nn, FFTW_BACKWARD, FFTW_ESTIMATE | FFTW_IN_PLACE,
		                                     x_in, istride, NULL, 0);
    /*
    /   Compute DFT
    */
