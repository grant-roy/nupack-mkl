...
int main()  /* COMPLEX_3D_EX13*/
{
    ...
    */
    Desc_Handle = fftw3d_create_plan( m, n, k, FFTW_FORWARD, FFTW_ESTIMATE | FFTW_IN_PLACE);
    /*
    /   Compute DFT
    */
    fftwnd_threads_one(1, Desc_Handle, &x_in[0][0][0], &x_in[0][0][0]);
    ...
    */
    Desc_Handle = fftw3d_create_plan( m, n, k, FFTW_BACKWARD, FFTW_ESTIMATE | FFTW_IN_PLACE);
    /*
    /   Compute DFT
    */
    fftwnd_threads_one(1, Desc_Handle, &x_in[0][0][0], &x_in[0][0][0]);
