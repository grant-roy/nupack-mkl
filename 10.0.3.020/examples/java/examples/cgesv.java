...
public final class cgesv {
     ...
     */
    private final static String test_name = "cgesv";
    ...
    public static boolean test()
    {
        ...
        float[] A = new float[] { 0,0, 1,0, 7,0, 4,0, 5,0,
                                  2,0, 0,0, 6,0, 6,0, 9,0,
                                  3,0, 5,0, 8,0, 0,0, 0,0,
                                  5,0, 6,0, 0,0, 3,0, 0,0,
                                  4,0, 6,0, 5,0, 9,0, 8,0 };
        float[] B = new float[] {14,0, 18,0, 26,0, 22,0, 22,0};
        int[] ipiv = new int[n];
        ...
        info = LAPACK.cgesv(n,nrhs,A,n,ipiv,B,n);
