...
public final class vsrngweibull {
    /**
     * Incarnation prohibited.
     */
    private vsrngweibull() {}

    /**
     * Individual name of this test.
     */
    private final static String test_name = "vsrngweibull";
    ...
    public static void test() throws Exception
    {
		...
		float r[] = new float [N];
		int i;
		final float alpha=1.0f,a=0.0f,beta=1.0f;
		...
		/***** Call RNG *****/
		errcode = VSL.vsRngWeibull( METHOD, stream, N, r, alpha, a, beta );
		...
		/***** Printing results *****/
		System.out.println("");
		System.out.println("Sample of vsRngWeibull.");
		System.out.println("-----------------------");
		System.out.println("");
