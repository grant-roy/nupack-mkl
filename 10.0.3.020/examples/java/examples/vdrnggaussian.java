...
public final class vdrnggaussian {
    /**
     * Incarnation prohibited.
     */
    private vdrnggaussian() {}

    /**
     * Individual name of this test.
     */
    private final static String test_name = "vdrnggaussian";
    ...
    public static void test() throws Exception
    {
		...
		/***** Call RNG *****/
		errcode = VSL.vdRngGaussian( METHOD, stream, N, r, a, sigma );
		...
		/***** Printing results *****/
		System.out.println("");
		System.out.println("Sample of vdRngGaussian.");
		System.out.println("------------------------");
		System.out.println("");
