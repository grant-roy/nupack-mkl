...
public final class virngpoissonv {
    /**
     * Incarnation prohibited.
     */
    private virngpoissonv() {}

    /**
     * Individual name of this test.
     */
    private final static String test_name = "virngpoissonv";
    ...
    public static void test() throws Exception
    {
		...
		/***** Call RNG *****/
		errcode = VSL.viRngPoissonV( METHOD, stream, N, r, lambda );
		...
		/***** Printing results *****/
		System.out.println("");
		System.out.println("Sample of viRngPoissonV.");
		System.out.println("-----------------------");
		System.out.println("");
		System.out.println("Parameters:");
		System.out.println("    lambda=" + lambda[0]);
		System.out.println("");
