...
public final class vspow {
     ...
     */
    private final static String test_name = "vspow";
    ...
    public static boolean test()
    {
        ...
        for(i=0;i<vec_len;i++) {
                fA1[i]=(float)(__SPOW_BEG+((__SPOW_END-__SPOW_BEG)*i)/vec_len);
                fA2[i]=(float)(__SPOW_BEG+((__SPOW_END-__SPOW_BEG)*i)/vec_len);
                fB1[i]=0.0f;
                fB2[i]=(float)Math.pow(fA1[i],fA2[i]);
        }

        VML.vsPow(vec_len,fA1,fA2,fB1);

        System.out.println("vsPow test/example program\n");
        System.out.println("           Argument                     vsPow                      Powf");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
