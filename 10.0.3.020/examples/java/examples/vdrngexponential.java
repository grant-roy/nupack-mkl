...
public final class vdrngexponential {
    /**
     * Incarnation prohibited.
     */
    private vdrngexponential() {}

    /**
     * Individual name of this test.
     */
    private final static String test_name = "vdrngexponential";
    ...
    public static void test() throws Exception
    {
		...
		/***** Call RNG *****/
		errcode = VSL.vdRngExponential( METHOD, stream, N, r, a, beta );
		...
		/***** Printing results *****/
		System.out.println("Sample of vdRngExponential.");
		System.out.println("---------------------------");
		System.out.println("");
