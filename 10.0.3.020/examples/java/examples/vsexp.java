...
public final class vsexp {
     ...
     */
    private final static String test_name = "vsexp";
    ...
    public static boolean test()
    {
        ...
        for(i=0;i<vec_len;i++) {
                ...
                fB1[i]=0.0f;
                fB2[i]=(float)Math.exp(fA[i]);
        }

        VML.vsExp(vec_len,fA,fB1);

        System.out.println("vsExp test/example program\n");
        System.out.println("           Argument                     vsExp                      Expf");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
