...
public final class vdatan {
     ...
     */
    private final static String test_name = "vdatan";
    ...
    public static boolean test()
    {
        ...
        for(i=0;i<vec_len;i++) {
                dA[i]=(double)(__DATAN_BEG+((__DATAN_END-__DATAN_BEG)*i)/vec_len);
                dB1[i]=0.0;
                dB2[i]=Math.atan(dA[i]);
        }

        VML.vdAtan(vec_len,dA,dB1);

        System.out.println("vdAtan test/example program\n");
        System.out.println("           Argument                     vdAtan                      Atan");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
