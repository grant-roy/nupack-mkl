...
public final class vscbrt {
     ...
     */
    private final static String test_name = "vscbrt";
    ...
    public static boolean test()
    {
        ...
        final float __SCBRT_BEG = 0.0f;
        final float __SCBRT_END = 10000.0f;
        ...
        for(i=0;i<vec_len;i++) {
                fA[i]=(float)(__SCBRT_BEG+((__SCBRT_END-__SCBRT_BEG)*i)/vec_len);
                fB1[i]=0.0f;
                fB2[i]=(float)Math.pow((fA[i]),1.0f/3.0f);
        }

        VML.vsCbrt(vec_len,fA,fB1);

        System.out.println("vsCbrt test/example program\n");
        System.out.println("           Argument                     vsCbrt                  powf(x,1.0/3.0)");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
