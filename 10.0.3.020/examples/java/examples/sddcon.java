...
/**
 * Example of using the analogy for the ESSL function <code>sddcon</code>.
 * The code of this example bases on the file <code>example_sddcon.c</code>
 * found inder the directory:
 * <ul>
 *   <li>${MKL}/examples/vslc/essl</li>
 * </ul>
 * The analogy of the ESSL's <code>sddcon</code> function is provided by
...
final public class sddcon {
    ...
    public static int test() {
        ...
        ESSL.sddcon( h, inch, x, incx, y, incy, nh, nx, iy0, ny, id );

        /***** Printing results *****/

        System.out.println(" 1-st Sample of sddcon.");
        System.out.println("----------------------");
        ...
        System.out.println(" 2-nd Sample of sddcon.");
        System.out.println("----------------------");
        System.out.println("Parameters:");
        System.out.println("Parameters:");
        System.out.println("    inch = " + inch +
