...
public final class vdcos {
     ...
     */
    private final static String test_name = "vdcos";
    ...
    public static boolean test()
    {
        ...
        for(i=0;i<vec_len;i++) {
                dA[i]=(double)(__DCOS_BEG+((__DCOS_END-__DCOS_BEG)*i)/vec_len);
                dB1[i]=0.0;
                dB2[i]=Math.cos(dA[i]);
        }

        VML.vdCos(vec_len,dA,dB1);

        System.out.println("vdCos test/example program\n");
        System.out.println("           Argument                     vdCos                      Cos");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
