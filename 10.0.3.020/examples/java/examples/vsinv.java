...
public final class vsinv {
     ...
     */
    private final static String test_name = "vsinv";
    ...
    public static boolean test()
    {
        ...
        final float __SINV_BEG = -10000.0f;
        final float __SINV_END = 10000.0f;
        ...
        for(i=0;i<vec_len;i++) {
                fA[i]=(float)(__SINV_BEG+((__SINV_END-__SINV_BEG)*i)/vec_len);
                fB1[i]=0.0f;
                fB2[i]=(float)(1.0f/fA[i]);
        }

        VML.vsInv(vec_len,fA,fB1);

        System.out.println("vsInv test/example program\n");
        System.out.println("           Argument                     vsInv                   1.0/x          ");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
