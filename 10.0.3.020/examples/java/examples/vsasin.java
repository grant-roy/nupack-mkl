...
public final class vsasin {
     ...
     */
    private final static String test_name = "vsasin";
    ...
    public static boolean test()
    {
        ...
        for(i=0;i<vec_len;i++) {
                fA[i]=(float)(__SASIN_BEG+((__SASIN_END-__SASIN_BEG)*i)/vec_len);
                fB1[i]=0.0f;
                fB2[i]=(float)Math.asin(fA[i]);
        }

        VML.vsAsin(vec_len,fA,fB1);

        System.out.println("vsAsin test/example program\n");
        System.out.println("           Argument                     vsAsin                      Asinf");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
