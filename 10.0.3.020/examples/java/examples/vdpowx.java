...
public final class vdpowx {
     ...
     */
    private final static String test_name = "vdpowx";
    ...
    public static boolean test()
    {
        ...
        dA2=(double)(__DPOWX_BEG+(__DPOWX_END-__DPOWX_BEG)/2);
        for(i=0;i<vec_len;i++) {
                dA1[i]=(double)(__DPOWX_BEG+((__DPOWX_END-__DPOWX_BEG)*i)/vec_len);
                dB1[i]=0.0;
                dB2[i]=Math.pow(dA1[i],dA2);
        }

        VML.vdPowx(vec_len,dA1,dA2,dB1);

        System.out.println("vdPowx test/example program\n");
        System.out.println("           Arguments                    vdPowx                     Pow");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
                System.out.println("" + dA1[i] + " " + dA2 + " " + dB1[i] + " " + dB2[i] + "");
