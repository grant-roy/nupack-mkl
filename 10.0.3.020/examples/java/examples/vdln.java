...
public final class vdln {
     ...
     */
    private final static String test_name = "vdln";
    ...
    public static boolean test()
    {
        ...
        for(i=0;i<vec_len;i++) {
                dA[i]=(double)(__DLN_BEG+((__DLN_END-__DLN_BEG)*i)/vec_len);
                dB1[i]=0.0;
                dB2[i]=Math.log(dA[i]);
        }

        VML.vdLn(vec_len,dA,dB1);

        System.out.println("vdLn test/example program\n");
        System.out.println("           Argument                     vdLn                      Log");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
