...
public final class vderfinv {
     ...
     */
    private final static String test_name = "vderfinv";
    ...
    public static boolean test()
    {
        ...
        final double __DERFINV_BEG = 0.01;
        final double __DERFINV_END = 0.99;
        ...
        VML.vdErfInv(vec_len,dA,dB1);

        System.out.println("vdErfInv test/example program\n");
        System.out.println("           Argument                     vdErfInv");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
