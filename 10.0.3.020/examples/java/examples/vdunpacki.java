...
public final class vdunpacki {
     ...
     */
    private final static String test_name = "vdunpacki";
    ...
    public static boolean test()
    {
        ...
        VML.vdUnpackI(vec_len,dB1,dB2,incra);

        System.out.println("vdUnpackI test/example program\n");
