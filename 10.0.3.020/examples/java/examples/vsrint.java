...
public final class vsrint {
     ...
     */
    private final static String test_name = "vsrint";
    ...
    public static boolean test()
    {
        ...
        final float __SRINT_BEG = -2.00f;
        final float __SRINT_END = 2.00f;
        ...
        for(i=0;i<vec_len;i++) {
                fA[i]=(float)(__SRINT_BEG+((__SRINT_END-__SRINT_BEG)*i)/vec_len);
                fB1[i]=0.0f;
        }

        VML.vsRint(vec_len,fA,fB1);

        System.out.println("vsRint test/example program\n");
        System.out.println("           Argument                     vsRint");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
