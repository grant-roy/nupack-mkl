...
public final class vdhypot {
     ...
     */
    private final static String test_name = "vdhypot";
    ...
    public static boolean test()
    {
        ...
        final double __DHYPOT_BEG = 1.001;
        final double __DHYPOT_END = 10000.0;
        ...
        VML.vdHypot(vec_len,dA1,dA2,dB1);

        System.out.println("vdHypot test/example program\n");
        System.out.println("           Arguments                    vdHypot");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
                System.out.println("" + dA1[i] + " " + dA2[i] + " " + dB1[i] + "");
        }
