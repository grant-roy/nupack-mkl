...
public final class dfti_c2 {
     ...
     */
    private final static String test_name = "dfti_c2";
    ...
    public static boolean test() throws DFTI.StatusException
    {
        ...
        float x_normal[]      = new float[2 * array_size];
        float x_transformed[] = new float[2 * array_size];
