...
public final class vzexp {
     ...
     */
    private final static String test_name = "vzexp";
    ...
    public static boolean test()
    {
        ...
        final double __DEXP_BEG = -17.0;
        final double __DEXP_END = 17.0;
        ...
        for(i=0;i<vec_len*2;i+=2) {
                zA[i]=(double)(__DEXP_BEG+((__DEXP_END-__DEXP_BEG)*i)/vec_len);
                zA[i+1]=(double)(__DEXP_END-((__DEXP_END-__DEXP_BEG)*i)/vec_len);
                zB1[i]=0.0;
                zB1[i+1]=0.0;
        }

        VML.vzExp(vec_len,zA,zB1);

        System.out.println("vzExp test/example program\n");
        System.out.println("           Argument                           vzExp");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len*2;i+=2) {
