...
public final class vdacos {
     ...
     */
    private final static String test_name = "vdacos";
    ...
    public static boolean test()
    {
        ...
        for(i=0;i<vec_len;i++) {
                ...
                dB1[i]=0.0;
                dB2[i]=Math.acos(dA[i]);
        }

        VML.vdAcos(vec_len,dA,dB1);

        System.out.println("vdAcos test/example program\n");
        System.out.println("           Argument                     vdAcos                      Acos");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
