...
public final class vsln {
     ...
     */
    private final static String test_name = "vsln";
    ...
    public static boolean test()
    {
        ...
        for(i=0;i<vec_len;i++) {
                fA[i]=(float)(__SLN_BEG+((__SLN_END-__SLN_BEG)*i)/vec_len);
                fB1[i]=0.0f;
                fB2[i]=(float)Math.log(fA[i]);
        }

        VML.vsLn(vec_len,fA,fB1);

        System.out.println("vsLn test/example program\n");
        System.out.println("           Argument                     vsLn                      logf");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
