...
public final class vserfc {
     ...
     */
    private final static String test_name = "vserfc";
    ...
    public static boolean test()
    {
        ...
        final float __SERFC_BEG = 1.0f;
        final float __SERFC_END = 4.0f;
        ...
        for(i=0;i<vec_len;i++) {
                fA[i]=(float)(__SERFC_BEG+((__SERFC_END-__SERFC_BEG)*i)/vec_len);
                fB1[i]=0.0f;
        }

        VML.vsErfc(vec_len,fA,fB1);

        System.out.println("vsErfc test/example program\n");
        System.out.println("           Argument                     vsErfc");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
