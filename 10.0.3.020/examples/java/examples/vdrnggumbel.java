...
public final class vdrnggumbel {
    /**
     ...
     */
    private final static String test_name = "vdrnggumbel";
    ...
    public static void test() throws Exception
    {
		...
		/***** Call RNG *****/
		errcode = VSL.vdRngGumbel( METHOD, stream, N, r, a, beta );
		...
		/***** Printing results *****/
		System.out.println("");
		System.out.println("Sample of vdRngGumbel.");
		System.out.println("----------------------");
		System.out.println("");
