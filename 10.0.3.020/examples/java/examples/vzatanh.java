...
public final class vzatanh {
     ...
     */
    private final static String test_name = "vzatanh";
    ...
    public static boolean test()
    {
        ...
        for(i=0;i<vec_len*2;i+=2) {
                zA[i]=(double)(__DATANH_BEG+((__DATANH_END-__DATANH_BEG)*i)/vec_len);
                zA[i+1]=(double)(__DATANH_END-((__DATANH_END-__DATANH_BEG)*i)/vec_len);
                zB1[i]=0.0;
                zB1[i+1]=0.0;
        }

        VML.vzAtanh(vec_len,zA,zB1);

        System.out.println("vzAtanh test/example program\n");
        System.out.println("           Argument                           vzAtanh");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len*2;i+=2) {
