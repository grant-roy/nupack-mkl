...
public final class virngnegbinomial {
    /**
     * Incarnation prohibited.
     */
    private virngnegbinomial() {}

    /**
     * Individual name of this test.
     */
    private final static String test_name = "virngnegbinomial";
    ...
    public static void test() throws Exception
    {
		...
		/***** Call RNG *****/
		errcode = VSL.viRngNegbinomial( METHOD, stream, N, r, a, p );
		...
		/***** Printing results *****/
		System.out.println("");
		System.out.println("Sample of viRngNegbinomial.");
		System.out.println("---------------------------");
		System.out.println("");
