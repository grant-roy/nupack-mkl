...
public final class vderfc {
     ...
     */
    private final static String test_name = "vderfc";
    ...
    public static boolean test()
    {
        ...
        final double __DERFC_BEG = 0.5;
        final double __DERFC_END = 5.9;
        ...
        for(i=0;i<vec_len;i++) {
                dA[i]=(double)(__DERFC_BEG+((__DERFC_END-__DERFC_BEG)*i)/vec_len);
                dB1[i]=0.0;
        }

        VML.vdErfc(vec_len,dA,dB1);

        System.out.println("vdErfc test/example program\n");
        System.out.println("           Argument                     vdErfc");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
