...
public final class vzln {
     ...
     */
    private final static String test_name = "vzln";
    ...
    public static boolean test()
    {
        ...
        final double __DLN_BEG = 0.1;
        final double __DLN_END = 10000.0;
        ...
        for(i=0;i<vec_len*2;i+=2) {
                zA[i]=(double)(__DLN_BEG+((__DLN_END-__DLN_BEG)*i)/vec_len);
                zA[i+1]=(double)(__DLN_END-((__DLN_END-__DLN_BEG)*i)/vec_len);
                zB1[i]=0.0;
                zB1[i+1]=0.0;
        }

        VML.vzLn(vec_len,zA,zB1);

        System.out.println("vzLn test/example program\n");
        System.out.println("           Argument                           vzLn");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len*2;i+=2) {
