...
public final class vdexp {
     ...
     */
    private final static String test_name = "vdexp";
    ...
    public static boolean test()
    {
        ...
        VML.vdExp(vec_len,dA,dB1);

        System.out.println("vdExp test/example program\n");
        System.out.println("           Argument                     vdExp                      Exp");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
