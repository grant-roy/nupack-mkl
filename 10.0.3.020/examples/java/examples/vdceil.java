...
public final class vdceil {
     ...
     */
    private final static String test_name = "vdceil";
    ...
    public static boolean test()
    {
        ...
        final double __DCEIL_BEG = -2.00;
        final double __DCEIL_END = 2.00;
        ...
        for(i=0;i<vec_len;i++) {
                dA[i]=(double)(__DCEIL_BEG+((__DCEIL_END-__DCEIL_BEG)*i)/vec_len);
                dB1[i]=0.0;
        }

        VML.vdCeil(vec_len,dA,dB1);

        System.out.println("vdCeil test/example program\n");
        System.out.println("           Argument                     vdCeil");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
