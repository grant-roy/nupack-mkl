...
public final class vsrnglaplace {
    /**
     * Incarnation prohibited.
     */
    private vsrnglaplace() {}

    /**
     * Individual name of this test.
     */
    private final static String test_name = "vsrnglaplace";
    ...
    public static void test() throws Exception
    {
		...
		/***** Call RNG *****/
		errcode = VSL.vsRngLaplace( METHOD, stream, N, r, a, beta );
		ErrCheck.CheckVslError( errcode );

		/***** Theoretical moments *****/
		tM=a;
		tD=2*beta*beta;
		tQ=24.0f*beta*beta*beta*beta;
		...
		/***** Printing results *****/
		System.out.println("");
		System.out.println("Sample of vsRngLaplace.");
		System.out.println("-----------------------");
		System.out.println("");
