...
public final class vsunpackm {
     ...
     */
    private final static String test_name = "vsunpackm";
    ...
    public static boolean test()
    {
        ...
        VML.vsUnpackM(vec_len,fB1,fB2,ma);

        System.out.println("vsUnpackM test/example program\n");
