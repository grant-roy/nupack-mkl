...
public final class vsacosh {
     ...
     */
    private final static String test_name = "vsacosh";
    ...
    public static boolean test()
    {
        ...
        VML.vsAcosh(vec_len,fA,fB1);

        System.out.println("vsAcosh test/example program\n");
        System.out.println("           Argument                     vsAcosh");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
