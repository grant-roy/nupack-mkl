...
public final class virngbinomial {
    /**
     * Incarnation prohibited.
     */
    private virngbinomial() {}

    /**
     * Individual name of this test.
     */
    private final static String test_name = "virngbinomial";
    ...
    public static void test() throws Exception
    {
		...
		/***** Call RNG *****/
		errcode = VSL.viRngBinomial( METHOD, stream, N, r, ntrial, p );
		...
		/***** Printing results *****/
		System.out.println("");
		System.out.println("Sample of viRngBinomial.");
		System.out.println("------------------------");
		System.out.println("");
