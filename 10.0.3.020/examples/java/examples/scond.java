...
/**
 * Example of using the analogy for the ESSL function <code>scond</code>.
 * The code of this example bases on the file <code>example_scond.c</code>
 * found inder the directory:
 * <ul>
 *   <li>${MKL}/examples/vslc/essl</li>
 * </ul>
 * The analogy of the ESSL's <code>scond</code> function is provided by
...
final public class scond {
    ...
    public static int test() {
        ...
        ESSL.scond( h, inch, x, incx, y, incy, nh, nx, iy0, ny );

        /***** Printing results *****/

        System.out.println(" 1-st Sample of scond.");
        System.out.println("----------------------");
        ...
        System.out.println(" 2-nd Sample of scond.");
        System.out.println("----------------------");
        System.out.println("Parameters:");
        System.out.println("    inch = " + inch +
                             ", incx = " + incx +
