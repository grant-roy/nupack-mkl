...
public final class vsrnggumbel {
    /**
     ...
     */
    private final static String test_name = "vsrnggumbel";
    ...
    public static void test() throws Exception
    {
		...
		/***** Call RNG *****/
		errcode = VSL.vsRngGumbel( METHOD, stream, N, r, a, beta );
		ErrCheck.CheckVslError( errcode );

		/***** Theoretical moments *****/
		tM=a+beta*(-0.5772156649f);
		tD=beta*beta*_PI*_PI/6.0f;
		tQ=14.61136365f*beta*beta*beta*beta;
		...
		/***** Printing results *****/
		System.out.println("");
		System.out.println("Sample of vsRngGumbel.");
		System.out.println("----------------------");
		System.out.println("");
