...
public final class vddiv {
     ...
     */
    private final static String test_name = "vddiv";
    ...
    public static boolean test()
    {
        ...
        final double __DDIV_BEG = -100.0;
        final double __DDIV_END = 100.0;
        ...
        for(i=0;i<vec_len;i++) {
                dA1[i]=(double)(__DDIV_BEG+((__DDIV_END-__DDIV_BEG)*i)/vec_len);
                dA2[i]=(double)(__DDIV_BEG+((__DDIV_END-__DDIV_BEG)*i)/vec_len);
                dB1[i]=0.0;
                dB2[i]=(dA1[i]/dA2[i]);
        }

        VML.vdDiv(vec_len,dA1,dA2,dB1);

        System.out.println("vdDiv test/example program\n");
        System.out.println("           Arguments                    vdDiv                      x/y");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
