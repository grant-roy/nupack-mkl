...
public final class vsrngexponential {
    /**
     * Incarnation prohibited.
     */
    private vsrngexponential() {}

    /**
     * Individual name of this test.
     */
    private final static String test_name = "vsrngexponential";
    ...
    public static void test() throws Exception
    {
		...
		/***** Call RNG *****/
		errcode = VSL.vsRngExponential( METHOD, stream, N, r, a, beta );
		ErrCheck.CheckVslError( errcode );

		/***** Theoretical moments *****/
		tM=a+beta;
		tD=beta*beta;
		tQ=9.0f*beta*beta*beta*beta;
		...
		/***** Printing results *****/
		System.out.println("Sample of vsRngExponential.");
		System.out.println("---------------------------");
		System.out.println("");
