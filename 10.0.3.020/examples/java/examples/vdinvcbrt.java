...
public final class vdinvcbrt {
     ...
     */
    private final static String test_name = "vdinvcbrt";
    ...
    public static boolean test()
    {
        ...
        final double __DINVCBRT_BEG = 0.1;
        final double __DINVCBRT_END = 10000.0;
        ...
        for(i=0;i<vec_len;i++) {
                dA[i]=(double)(__DINVCBRT_BEG+((__DINVCBRT_END-__DINVCBRT_BEG)*i)/vec_len);
                dB1[i]=0.0;
                dB2[i]=1.0/Math.pow((dA[i]),1.0/3.0);
        }

        VML.vdInvCbrt(vec_len,dA,dB1);

        System.out.println("vdInvCbrt test/example program\n");
        System.out.println("           Argument                     vdInvCbrt            1.0/Math.pow(x,1.0/3.0)");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
