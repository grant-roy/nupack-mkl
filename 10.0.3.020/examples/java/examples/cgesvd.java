...
public final class cgesvd {
     ...
     */
    private final static String test_name = "cgesvd";
    ...
    public static boolean test()
    {
        ...
        float[] A = new float[] { -2,0,  2,0,  6,0,  1,0, -2,0,
                                  -8,0, -5,0,  0,0,  0,0, 11,0,
                                   1,0,  6,0,  2,0,  4,0,  0,0 };

        float[] s = new float[minmn];
        float[] u = new float[2*m*m];
        float[] vt = new float[2*n*n];
        float[] sd = new float[minmn-1];

		float[] AA = new float[2*m*n];
        for(i=0;i<2*m*n;i++) {
			AA[i] = A[i];
        }
        ...
        info = LAPACK.cgesvd(LAPACK.JOB.JobN,LAPACK.JOB.JobN,m,n,A,m,s,null,1,null,1,sd);
        ...
        info = LAPACK.cgesvd(LAPACK.JOB.JobN,LAPACK.JOB.JobS,m,n,A,m,s,null,1,vt,minmn,sd);
