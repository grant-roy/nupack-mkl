...
public final class vssinh {
     ...
     */
    private final static String test_name = "vssinh";
    ...
    public static boolean test()
    {
        ...
        final float __SSINH_BEG = -7.0f;
        final float __SSINH_END = 7.0f;
        ...
        for(i=0;i<vec_len;i++) {
                fA[i]=(float)(__SSINH_BEG+((__SSINH_END-__SSINH_BEG)*i)/vec_len);
                fB1[i]=0.0f;
                //fB2[i]=(float)Math.sinh(fA[i]);   // Since 1.5
                fB2[i]=(float)(Math.exp(fA[i])-Math.exp(-fA[i]))/2.0f;
        }

        VML.vsSinh(vec_len,fA,fB1);

        System.out.println("vsSinh test/example program\n");
        System.out.println("           Argument                     vsSinh                     Sinhf");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
