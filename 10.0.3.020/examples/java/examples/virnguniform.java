...
public final class virnguniform {
    /**
     * Incarnation prohibited.
     */
    private virnguniform() {}

    /**
     * Individual name of this test.
     */
    private final static String test_name = "virnguniform";
    ...
    public static void test() throws Exception
    {
		...
		/***** Call RNG *****/
		errcode = VSL.viRngUniform( METHOD, stream, N, r, a, b );
		...
		/***** Printing results *****/
		System.out.println("");
		System.out.println("Sample of viRngUniform.");
		System.out.println("-----------------------");
		System.out.println("");
