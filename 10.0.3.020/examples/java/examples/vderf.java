...
public final class vderf {
     ...
     */
    private final static String test_name = "vderf";
    ...
    public static boolean test()
    {
        ...
        final double __DERF_BEG = 0.5;
        final double __DERF_END = 5.9;
        ...
        for(i=0;i<vec_len;i++) {
                dA[i]=(double)(__DERF_BEG+((__DERF_END-__DERF_BEG)*i)/vec_len);
                dB1[i]=0.0;
        }

        VML.vdErf(vec_len,dA,dB1);

        System.out.println("vdErf test/example program\n");
        System.out.println("           Argument                     vdErf");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
