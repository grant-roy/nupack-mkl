...
/**
 * Example of using the analogy for the ESSL function <code>scorf</code>.
 * The code of this example bases on the file <code>example_scorf.c</code>
 * found inder the directory:
 * <ul>
 *   <li>${MKL}/examples/vslc/essl</li>
 * </ul>
 * The analogy of the ESSL's <code>scorf</code> function is provided by
...
final public class scorf {
    ...
    public static int test() {
        ...
        System.out.println(" Sample of scorf.");
        System.out.println("----------------------");
