...
public final class vdsinh {
     ...
     */
    private final static String test_name = "vdsinh";
    ...
    public static boolean test()
    {
        ...
        final double __DSINH_BEG = -7.0;
        final double __DSINH_END = 7.0;
        ...
        for(i=0;i<vec_len;i++) {
                dA[i]=(double)(__DSINH_BEG+((__DSINH_END-__DSINH_BEG)*i)/vec_len);
                dB1[i]=0.0;
                //dB2[i]=Math.sinh(dA[i]);   // Since 1.5
                dB2[i]=(Math.exp(dA[i])-Math.exp(-dA[i]))/2.0;
        }

        VML.vdSinh(vec_len,dA,dB1);

        System.out.println("vdSinh test/example program\n");
        System.out.println("           Argument                     vdSinh                     Sinh");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
