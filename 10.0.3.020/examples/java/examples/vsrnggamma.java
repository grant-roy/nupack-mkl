...
public final class vsrnggamma {
     ...
     */
    private final static String test_name = "vsrnggamma";
    ...
    public static void test() throws Exception
    {
		...
		float r[] = new float [N];
		int i;
		final float alpha = 2.0f, a=0.0f, beta=1.0f;
		...
		/***** Call RNG *****/
		errcode = VSL.vsRngGamma( METHOD, stream, N, r, alpha, a, beta );
		...
		/***** Printing results *****/
		System.out.println("");
		System.out.println("Sample of vsRngGamma.");
		System.out.println("----------------------");
		System.out.println("");
