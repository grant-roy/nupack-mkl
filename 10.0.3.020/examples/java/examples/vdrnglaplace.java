...
public final class vdrnglaplace {
    /**
     * Incarnation prohibited.
     */
    private vdrnglaplace() {}

    /**
     * Individual name of this test.
     */
    private final static String test_name = "vdrnglaplace";
    ...
    public static void test() throws Exception
    {
		...
		/***** Call RNG *****/
		errcode = VSL.vdRngLaplace( METHOD, stream, N, r, a, beta );
		...
		/***** Printing results *****/
		System.out.println("");
		System.out.println("Sample of vdRngLaplace.");
		System.out.println("-----------------------");
		System.out.println("");
