...
public final class vdinv {
     ...
     */
    private final static String test_name = "vdinv";
    ...
    public static boolean test()
    {
        ...
        final double __DINV_BEG = -10000.0;
        final double __DINV_END = 10000.0;
        ...
        for(i=0;i<vec_len;i++) {
                dA[i]=(double)(__DINV_BEG+((__DINV_END-__DINV_BEG)*i)/vec_len);
                dB1[i]=0.0;
                dB2[i]=1.0/dA[i];
        }

        VML.vdInv(vec_len,dA,dB1);

        System.out.println("vdInv test/example program\n");
        System.out.println("           Argument                     vdInv                    1.0/x         ");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
