...
public final class vsatan2 {
     ...
     */
    private final static String test_name = "vsatan2";
    ...
    public static boolean test()
    {
        ...
        final float __SATAN2_BEG = -10000.0f;
        final float __SATAN2_END = 10000.0f;

        float[] fA1 = new float[VEC_LEN];
        float[] fA2 = new float[VEC_LEN];
        ...
        for(i=0;i<vec_len;i++) {
                fA1[i]=(float)(__SATAN2_BEG+((__SATAN2_END-__SATAN2_BEG)*i)/vec_len);
                fA2[i]=(float)(__SATAN2_BEG+((__SATAN2_END-__SATAN2_BEG)*i)/vec_len);
                fB1[i]=0.0f;
                fB2[i]=(float)Math.atan2(fA1[i],fA2[i]);
        }

        VML.vsAtan2(vec_len,fA1,fA2,fB1);

        System.out.println("vsAtan2 test/example program\n");
        System.out.println("           Argument                     vsAtan2                    Atan2f");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
                System.out.println("" + fA1[i] + " " + fA2[i] + " " + fB1[i] + " " + fB2[i] + "");
