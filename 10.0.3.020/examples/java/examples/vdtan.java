...
public final class vdtan {
     ...
     */
    private final static String test_name = "vdtan";
    ...
    public static boolean test()
    {
        ...
        for(i=0;i<vec_len;i++) {
                dA[i]=(double)(__DTAN_BEG+((__DTAN_END-__DTAN_BEG)*i)/vec_len);
                dB1[i]=0.0;
                dB2[i]=Math.tan(dA[i]);
        }

        VML.vdTan(vec_len,dA,dB1);

        System.out.println("vdTan test/example program\n");
        System.out.println("           Argument                     vdTan                      Tan");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
