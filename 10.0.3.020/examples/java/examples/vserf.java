...
public final class vserf {
     ...
     */
    private final static String test_name = "vserf";
    ...
    public static boolean test()
    {
        ...
        final float __SERF_BEG = 1.0f;
        final float __SERF_END = 4.0f;
        ...
        for(i=0;i<vec_len;i++) {
                fA[i]=(float)(__SERF_BEG+((__SERF_END-__SERF_BEG)*i)/vec_len);
                fB1[i]=0.0f;
        }

        VML.vsErf(vec_len,fA,fB1);

        System.out.println("vsErf test/example program\n");
        System.out.println("           Argument                     vsErf");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
