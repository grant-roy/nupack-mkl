...
public final class vcexp {
     ...
     */
    private final static String test_name = "vcexp";
    ...
    public static boolean test()
    {
        ...
        final float __SEXP_BEG = -17.0f;
        final float __SEXP_END = 18.0f;
        ...
        for(i=0;i<vec_len*2;i+=2) {
                cA[i]=(float)(__SEXP_BEG+((__SEXP_END-__SEXP_BEG)*i)/vec_len);
                cA[i+1]=(float)(__SEXP_END-((__SEXP_END-__SEXP_BEG)*i)/vec_len);
                cB1[i]=0.0f;
                cB1[i+1]=0.0f;
        }

        VML.vcExp(vec_len,cA,cB1);

        System.out.println("vcExp test/example program\n");
        System.out.println("           Argument                           vcExp");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len*2;i+=2) {
