...
public final class vsrnguniform {
    /**
     * Incarnation prohibited.
     */
    private vsrnguniform() {}

    /**
     * Individual name of this test.
     */
    private final static String test_name = "vsrnguniform";
    ...
    public static void test() throws Exception
    {
		...
		/***** Call RNG *****/
		errcode = VSL.vsRngUniform( METHOD, stream, N, r, a, b );
		ErrCheck.CheckVslError( errcode );

		/***** Theoretical moments *****/
		tM=(b+a)/2.0f;
		tD=((b-a)*(b-a))/12.0f;
		tQ=((b-a)*(b-a)*(b-a)*(b-a))/80.0f;
		...
		/***** Printing results *****/
		System.out.println("");
		System.out.println("Sample of vsRngUniform.");
		System.out.println("-----------------------");
		System.out.println("");
