...
public final class vssqrt {
     ...
     */
    private final static String test_name = "vssqrt";
    ...
    public static boolean test()
    {
        ...
        for(i=0;i<vec_len;i++) {
                fA[i]=(float)(__SSQRT_BEG+((__SSQRT_END-__SSQRT_BEG)*i)/vec_len);
                fB1[i]=0.0f;
                fB2[i]=(float)Math.sqrt(fA[i]);
        }

        VML.vsSqrt(vec_len,fA,fB1);

        System.out.println("vsSqrt test/example program\n");
        System.out.println("           Argument                     vsSqrt                     Sqrtf");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
