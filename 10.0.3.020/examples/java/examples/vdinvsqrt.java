...
public final class vdinvsqrt {
     ...
     */
    private final static String test_name = "vdinvsqrt";
    ...
    public static boolean test()
    {
        ...
        final double __DINVSQRT_BEG = 0.1;
        final double __DINVSQRT_END = 10000.0;
        ...
        for(i=0;i<vec_len;i++) {
                dA[i]=(double)(__DINVSQRT_BEG+((__DINVSQRT_END-__DINVSQRT_BEG)*i)/vec_len);
                dB1[i]=0.0;
                dB2[i]=1.0/Math.sqrt(dA[i]);
        }

        VML.vdInvSqrt(vec_len,dA,dB1);

        System.out.println("vdInvSqrt test/example program\n");
        System.out.println("           Argument                     vdInvSqrt                  1.0/Sqrt");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
