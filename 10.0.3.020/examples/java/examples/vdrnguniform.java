...
public final class vdrnguniform {
    /**
     * Incarnation prohibited.
     */
    private vdrnguniform() {}

    /**
     * Individual name of this test.
     */
    private final static String test_name = "vdrnguniform";
    ...
    public static void test() throws Exception
    {
		...
		/***** Call RNG *****/
		errcode = VSL.vdRngUniform( METHOD, stream, N, r, a, b );
		...
		/***** Printing results *****/
		System.out.println("");
		System.out.println("Sample of vdRngUniform.");
		System.out.println("-----------------------");
		System.out.println("");
