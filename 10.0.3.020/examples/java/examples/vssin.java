...
public final class vssin {
     ...
     */
    private final static String test_name = "vssin";
    ...
    public static boolean test()
    {
        ...
        for(i=0;i<vec_len;i++) {
                fA[i]=(float)(__SSIN_BEG+((__SSIN_END-__SSIN_BEG)*i)/vec_len);
                fB1[i]=0.0f;
                fB2[i]=(float)Math.sin(fA[i]);
        }

        VML.vsSin(vec_len,fA,fB1);

        System.out.println("vsSin test/example program\n");
        System.out.println("           Argument                     vsSin                      Sinf");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
