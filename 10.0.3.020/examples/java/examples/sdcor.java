...
/**
 * Example of using the analogy for the ESSL function <code>sdcor</code>.
 * The code of this example bases on the file <code>example_sdcor.c</code>
 * found inder the directory:
 * <ul>
 *   <li>${MKL}/examples/vslc/essl</li>
 * </ul>
 * The analogy of the ESSL's <code>sdcor</code> function is provided by
...
final public class sdcor {
    ...
    public static int test() {
        ...
        ESSL.sdcor( h, inch, x, incx, y, incy, nh, nx, iy0, ny, id );

        /***** Printing results *****/

        System.out.println(" 1-st Sample of sdcor.");
        System.out.println("----------------------");
        ...
        System.out.println(" 2-nd Sample of sdcor.");
        System.out.println("----------------------");
        System.out.println("Parameters:");
        System.out.println("    inch = " + inch +
                             ", incx = " + incx +
        ...
        System.out.println("Results:");
        System.out.println("---------------------------");
        for( i=0; i < ny; i++ ) System.out.println("y[" + (i*incy) + " ] = " + y[i*incy]);
        for( i = 0; i < 3; i++ ) {
