...
public final class vsacos {
     ...
     */
    private final static String test_name = "vsacos";
    ...
    public static boolean test()
    {
        ...
        for(i=0;i<vec_len;i++) {
                fA[i]=(float)(__SACOS_BEG+((__SACOS_END-__SACOS_BEG)*i)/vec_len);
                fB1[i]=0.0f;
                fB2[i]=(float)Math.acos(fA[i]);
        }

        VML.vsAcos(vec_len,fA,fB1);

        System.out.println("vsAcos test/example program\n");
        System.out.println("           Argument                     vsAcos                      Acosf");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
