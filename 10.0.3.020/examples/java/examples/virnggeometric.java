...
public final class virnggeometric {
    /**
     * Incarnation prohibited.
     */
    private virnggeometric() {}

    /**
     * Individual name of this test.
     */
    private final static String test_name = "virnggeometric";
    ...
    public static void test() throws Exception
    {
		...
		/***** Call RNG *****/
		errcode = VSL.viRngGeometric( METHOD, stream, N, r, p );
		...
		/***** Printing results *****/
		System.out.println("");
		System.out.println("Sample of viRngGeometric.");
		System.out.println("-------------------------");
		System.out.println("");
