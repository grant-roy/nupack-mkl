...
public final class virngpoisson {
    /**
     * Incarnation prohibited.
     */
    private virngpoisson() {}

    /**
     * Individual name of this test.
     */
    private final static String test_name = "virngpoisson";
    ...
    public static void test() throws Exception
    {
		...
		/***** Call RNG *****/
		errcode = VSL.viRngPoisson( METHOD, stream, N, r, lambda );
		...
		/***** Printing results *****/
		System.out.println("");
		System.out.println("Sample of viRngPoisson.");
		System.out.println("-----------------------");
		System.out.println("");
