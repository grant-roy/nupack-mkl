...
public final class vsrnggaussian {
    /**
     * Incarnation prohibited.
     */
    private vsrnggaussian() {}

    /**
     * Individual name of this test.
     */
    private final static String test_name = "vsrnggaussian";
    ...
    public static void test() throws Exception
    {
		...
		/***** Call RNG *****/
		errcode = VSL.vsRngGaussian( METHOD, stream, N, r, a, sigma );
		ErrCheck.CheckVslError( errcode );

		/***** Theoretical moments *****/
		tM=a;
		tD=sigma*sigma;
		tQ=720.0f*sigma*sigma*sigma*sigma;
		...
		/***** Printing results *****/
		System.out.println("");
		System.out.println("Sample of vsRngGaussian.");
		System.out.println("------------------------");
		System.out.println("");
