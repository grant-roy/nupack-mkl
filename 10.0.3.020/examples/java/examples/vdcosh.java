...
public final class vdcosh {
     ...
     */
    private final static String test_name = "vdcosh";
    ...
    public static boolean test()
    {
        ...
        final double __DCOSH_BEG = -7.0;
        final double __DCOSH_END = 7.0;
        ...
        for(i=0;i<vec_len;i++) {
                dA[i]=(double)(__DCOSH_BEG+((__DCOSH_END-__DCOSH_BEG)*i)/vec_len);
                dB1[i]=0.0;
                //dB2[i]=Math.cosh(dA[i]);   // Since 1.5
                dB2[i]=(Math.exp(dA[i])+Math.exp(-dA[i]))/2.0;
        }

        VML.vdCosh(vec_len,dA,dB1);

        System.out.println("vdCosh test/example program\n");
        System.out.println("           Argument                     vdCosh                     Cosh");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
