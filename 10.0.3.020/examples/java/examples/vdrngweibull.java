...
public final class vdrngweibull {
    /**
     * Incarnation prohibited.
     */
    private vdrngweibull() {}

    /**
     * Individual name of this test.
     */
    private final static String test_name = "vdrngweibull";
    ...
    public static void test() throws Exception
    {
		...
		int i;
		final double alpha=1.0,a=0.0,beta=1.0;
		...
		/***** Call RNG *****/
		errcode = VSL.vdRngWeibull( METHOD, stream, N, r, alpha, a, beta );
		...
		/***** Printing results *****/
		System.out.println("");
		System.out.println("Sample of vdRngWeibull.");
		System.out.println("-----------------------");
		System.out.println("");
