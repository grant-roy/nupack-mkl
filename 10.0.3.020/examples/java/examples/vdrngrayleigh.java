...
public final class vdrngrayleigh {
    /**
     * Incarnation prohibited.
     */
    private vdrngrayleigh() {}

    /**
     * Individual name of this test.
     */
    private final static String test_name = "vdrngrayleigh";
    ...
    public static void test() throws Exception
    {
        ...
        final int N = 1000;
        final int NN = 10;
        final double _PI = 3.141592653589793238462643383279502884197;
		...
		/***** Call RNG *****/
		errcode = VSL.vdRngRayleigh( METHOD, stream, N, r, a, beta );
		ErrCheck.CheckVslError( errcode );

		/***** Theoretical moments *****/
		tM=a+beta*Math.sqrt(_PI)*0.5;
		...
		/***** Printing results *****/
		System.out.println("");
		System.out.println("Sample of vdRngRayleigh.");
		System.out.println("------------------------");
		System.out.println("");
