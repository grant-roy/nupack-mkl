...
public final class vspowx {
     ...
     */
    private final static String test_name = "vspowx";
    ...
    public static boolean test()
    {
        ...
        fA2=(float)(__SPOWX_BEG+(__SPOWX_END-__SPOWX_BEG)/2);
        for(i=0;i<vec_len;i++) {
                fA1[i]=(float)(__SPOWX_BEG+((__SPOWX_END-__SPOWX_BEG)*i)/vec_len);
                fB1[i]=0.0f;
                fB2[i]=(float)Math.pow(fA1[i],fA2);
        }

        VML.vsPowx(vec_len,fA1,fA2,fB1);

        System.out.println("vsPowx test/example program\n");
        System.out.println("           Argument                     vsPowx                     Powf");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
                System.out.println("" + fA1[i] + " " + fA2 + " " + fB1[i] + " " + fB2[i] + "");
