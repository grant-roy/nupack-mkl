...
public final class vscosh {
     ...
     */
    private final static String test_name = "vscosh";
    ...
    public static boolean test()
    {
        ...
        final float __SCOSH_BEG = -7.0f;
        final float __SCOSH_END = 7.0f;
        ...
        for(i=0;i<vec_len;i++) {
                fA[i]=(float)(__SCOSH_BEG+((__SCOSH_END-__SCOSH_BEG)*i)/vec_len);
                fB1[i]=0.0f;
                //fB2[i]=(float)Math.cosh(fA[i]);   // Since 1.5
                fB2[i]=(float)(Math.exp(fA[i])+Math.exp(-fA[i]))/2.0f;
        }

        VML.vsCosh(vec_len,fA,fB1);

        System.out.println("vsCosh test/example program\n");
        System.out.println("           Argument                     vsCosh                     Coshf");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
