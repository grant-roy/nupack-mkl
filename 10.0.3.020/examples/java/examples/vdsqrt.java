...
public final class vdsqrt {
     ...
     */
    private final static String test_name = "vdsqrt";
    ...
    public static boolean test()
    {
        ...
        for(i=0;i<vec_len;i++) {
                dA[i]=(double)(__DSQRT_BEG+((__DSQRT_END-__DSQRT_BEG)*i)/vec_len);
                dB1[i]=0.0;
                dB2[i]=Math.sqrt(dA[i]);
        }

        VML.vdSqrt(vec_len,dA,dB1);

        System.out.println("vdSqrt test/example program\n");
        System.out.println("           Argument                     vdSqrt                     Sqrt");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
