...
public final class vdpow {
     ...
     */
    private final static String test_name = "vdpow";
    ...
    public static boolean test()
    {
        ...
        for(i=0;i<vec_len;i++) {
                dA1[i]=(double)(__DPOW_BEG+((__DPOW_END-__DPOW_BEG)*i)/vec_len);
                dA2[i]=(double)(__DPOW_BEG+((__DPOW_END-__DPOW_BEG)*i)/vec_len);
                dB1[i]=0.0;
                dB2[i]=Math.pow(dA1[i],dA2[i]);
        }

        VML.vdPow(vec_len,dA1,dA2,dB1);

        System.out.println("vdPow test/example program\n");
        System.out.println("           Arguments                    vdPow                      Pow");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
