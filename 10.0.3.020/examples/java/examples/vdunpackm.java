...
public final class vdunpackm {
     ...
     */
    private final static String test_name = "vdunpackm";
    ...
    public static boolean test()
    {
        ...
        VML.vdPackM(vec_len,dA,ma,dB1);
        VML.vdUnpackM(vec_len,dB1,dB2,ma);

        System.out.println("vdUnpackM test/example program\n");
        System.out.println("           Before packing             After packing          After Unpacking");
        System.out.println("===============================================================================");
        for(i=0;i<VEC_LEN;i++) {
                System.out.print("" + dA[i] + " ");
                System.out.print("" + dB1[i] + " ");
                System.out.print("" + dB2[i] + "");
                System.out.println("");
        }
