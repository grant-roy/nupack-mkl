...
public final class vdrint {
     ...
     */
    private final static String test_name = "vdrint";
    ...
    public static boolean test()
    {
        ...
        final double __DRINT_BEG = -2.00;
        final double __DRINT_END = 2.00;
        ...
        for(i=0;i<vec_len;i++) {
                dA[i]=(double)(__DRINT_BEG+((__DRINT_END-__DRINT_BEG)*i)/vec_len);
                dB1[i]=0.0;
        }

        VML.vdRint(vec_len,dA,dB1);

        System.out.println("vdRint test/example program\n");
        System.out.println("           Argument                     vdRint");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
