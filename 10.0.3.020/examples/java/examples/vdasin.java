...
public final class vdasin {
     ...
     */
    private final static String test_name = "vdasin";
    ...
    public static boolean test()
    {
        ...
        for(i=0;i<vec_len;i++) {
                dA[i]=(double)(__DASIN_BEG+((__DASIN_END-__DASIN_BEG)*i)/vec_len);
                dB1[i]=0.0;
                dB2[i]=Math.asin(dA[i]);
        }

        VML.vdAsin(vec_len,dA,dB1);

        System.out.println("vdAsin test/example program\n");
        System.out.println("           Argument                     vdAsin                      Asin");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
