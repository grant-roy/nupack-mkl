...
public final class vsatan {
     ...
     */
    private final static String test_name = "vsatan";
    ...
    public static boolean test()
    {
        ...
        for(i=0;i<vec_len;i++) {
                fA[i]=(float)(__SATAN_BEG+((__SATAN_END-__SATAN_BEG)*i)/vec_len);
                fB1[i]=0.0f;
                fB2[i]=(float)Math.atan(fA[i]);
        }

        VML.vsAtan(vec_len,fA,fB1);

        System.out.println("vsAtan test/example program\n");
        System.out.println("           Argument                     vsAtan                      Atanf");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
