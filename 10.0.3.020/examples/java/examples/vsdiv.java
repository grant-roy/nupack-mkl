...
public final class vsdiv {
     ...
     */
    private final static String test_name = "vsdiv";
    ...
    public static boolean test()
    {
        ...
        final float __SDIV_BEG = -10000.0f;
        final float __SDIV_END = 10000.0f;
        ...
        VML.vsDiv(vec_len,fA1,fA2,fB1);

        System.out.println("vsDiv test/example program\n");
        System.out.println("           Argument                     vsDiv                      x/y");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
