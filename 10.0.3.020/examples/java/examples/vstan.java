...
public final class vstan {
     ...
     */
    private final static String test_name = "vstan";
    ...
    public static boolean test()
    {
        ...
        for(i=0;i<vec_len;i++) {
                ...
                fB1[i]=0.0f;
                fB2[i]=(float)Math.tan(fA[i]);
        }

        VML.vsTan(vec_len,fA,fB1);

        System.out.println("vsTan test/example program\n");
        System.out.println("           Argument                     vsTan                      Tanf");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
