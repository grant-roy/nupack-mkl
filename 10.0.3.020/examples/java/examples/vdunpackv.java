...
public final class vdunpackv {
     ...
     */
    private final static String test_name = "vdunpackv";
    ...
    public static boolean test()
    {
        ...
        VML.vdPackV(vec_len,dA,ia,dB1);
        VML.vdUnpackV(vec_len,dB1,dB2,ia);

        System.out.println("vdUnpackV test/example program\n");
