...
public final class vcasinh {
     ...
     */
    private final static String test_name = "vcasinh";
    ...
    public static boolean test()
    {
        ...
        for(i=0;i<vec_len*2;i+=2) {
                cA[i]=(float)(__SASINH_BEG+((__SASINH_END-__SASINH_BEG)*i)/vec_len);
                cA[i+1]=(float)(__SASINH_END-((__SASINH_END-__SASINH_BEG)*i)/vec_len);
                cB1[i]=0.0f;
                cB1[i+1]=0.0f;
        }

        VML.vcAsinh(vec_len,cA,cB1);

        System.out.println("vcAsinh test/example program\n");
        System.out.println("           Argument                           vcAsinh");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len*2;i+=2) {
