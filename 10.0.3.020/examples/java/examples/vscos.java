...
public final class vscos {
     ...
     */
    private final static String test_name = "vscos";
    ...
    public static boolean test()
    {
        ...
        for(i=0;i<vec_len;i++) {
                fA[i]=(float)(__SCOS_BEG+((__SCOS_END-__SCOS_BEG)*i)/vec_len);
                fB1[i]=0.0f;
                fB2[i]=(float)Math.cos(fA[i]);
        }

        VML.vsCos(vec_len,fA,fB1);

        System.out.println("vsCos test/example program\n");
        System.out.println("           Argument                     vsCos                      Cosf");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
