...
public final class dfti_d1i {
     ...
     */
    private final static String test_name = "dfti_d1i";
    ...
    public static boolean test() throws DFTI.StatusException
    {
        ...
        //
        double x_inout[] = new double [ length ];
        ...
        */
        ...
        boolean fault = false;
        for (int i=0; i<length; i++) {
            System.out.print("\t" + x_inout[i]);
            if (Math.abs(x_inout[i]-i) > tolerance)
                fault = true;
        }
        System.out.println();
