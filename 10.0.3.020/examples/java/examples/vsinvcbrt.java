...
public final class vsinvcbrt {
     ...
     */
    private final static String test_name = "vsinvcbrt";
    ...
    public static boolean test()
    {
        ...
        final float __SINVCBRT_BEG = 0.1f;
        final float __SINVCBRT_END = 10000.0f;
        ...
        for(i=0;i<vec_len;i++) {
                fA[i]=(float)(__SINVCBRT_BEG+((__SINVCBRT_END-__SINVCBRT_BEG)*i)/vec_len);
                fB1[i]=0.0f;
                fB2[i]=(float)(1.0f/Math.pow((fA[i]),1.0f/3.0f));
        }

        VML.vsInvCbrt(vec_len,fA,fB1);

        System.out.println("vsInvCbrt test/example program\n");
        System.out.println("           Argument                     vsInvCbrt           1.0/powf(x,1.0/3.0)");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
