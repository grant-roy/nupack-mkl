...
public final class vdnearbyint {
    /**
     ...
     */
    private final static String test_name = "vdnearbyint";
    ...
    public static boolean test()
    {
        ...
        final double __DNEARBYINT_BEG = -2.00;
        final double __DNEARBYINT_END = 2.00;
        ...
        VML.vdNearbyInt(vec_len,dA,dB1);

        System.out.println("vdNearbyInt test/example program\n");
        System.out.println("           Argument                     vdNearbyInt");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
