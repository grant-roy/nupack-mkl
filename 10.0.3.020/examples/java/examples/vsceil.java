...
public final class vsceil {
     ...
     */
    private final static String test_name = "vsceil";
    ...
    public static boolean test()
    {
        ...
        final float __SCEIL_BEG = -2.00f;
        final float __SCEIL_END = 2.00f;
        ...
        for(i=0;i<vec_len;i++) {
                fA[i]=(float)(__SCEIL_BEG+((__SCEIL_END-__SCEIL_BEG)*i)/vec_len);
                fB1[i]=0.0f;
        }

        VML.vsCeil(vec_len,fA,fB1);

        System.out.println("vsCeil test/example program\n");
        System.out.println("           Argument                     vsCeil");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
