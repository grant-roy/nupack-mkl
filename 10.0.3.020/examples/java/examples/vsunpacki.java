...
public final class vsunpacki {
     ...
     */
    private final static String test_name = "vsunpacki";
    ...
    public static boolean test()
    {
        ...
        VML.vsPackI(vec_len,fA,incra,fB1);
        VML.vsUnpackI(vec_len,fB1,fB2,incra);

        System.out.println("vsUnpackI test/example program\n");
