...
public final class vdlog10 {
     ...
     */
    private final static String test_name = "vdlog10";
    ...
    public static boolean test()
    {
        ...
        final double __DLOG10_BEG = 0.1;
        final double __DLOG10_END = 10000.0;
        ...
        for(i=0;i<vec_len;i++) {
                dA[i]=(double)(__DLOG10_BEG+((__DLOG10_END-__DLOG10_BEG)*i)/vec_len);
                dB1[i]=0.0;
                //dB2[i]=Math.log10(dA[i]);   // Since 1.5
                dB2[i]=(0.43429448190325182765*Math.log(dA[i]));
        }

        VML.vdLog10(vec_len,dA,dB1);

        System.out.println("vdLog10 test/example program\n");
        System.out.println("           Argument                     vdLog10                    Log10");
        System.out.println("===============================================================================");
        for(i=0;i<vec_len;i++) {
