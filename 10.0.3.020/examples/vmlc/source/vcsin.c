...
int main()
{
  ...
  for(i=0;i<vec_len;i++) {
    cA[i].real=(float)(__SSIN_BEG/1000+((__SSIN_END/1000-__SSIN_BEG/1000)*i)/vec_len);
    cA[i].imag=(float)(__SSIN_END/1000-((__SSIN_END/1000-__SSIN_BEG/1000)*i)/vec_len);
    cB1[i].real=0.0;
    cB1[i].imag=0.0;
  }

  vcSin(vec_len,cA,cB1);
