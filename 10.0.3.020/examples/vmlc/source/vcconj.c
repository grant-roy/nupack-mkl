...
int main()
{
  ...
  for(i=0;i<vec_len;i++) {
    cA[i].real=(float)(__SCONJ_BEG/1000+((__SCONJ_END/1000-__SCONJ_BEG/1000)*i)/vec_len);
    cA[i].imag=(float)(__SCONJ_END/1000-((__SCONJ_END/1000-__SCONJ_BEG/1000)*i)/vec_len);
    cB1[i].real=0.0;
    cB1[i].imag=0.0;
  }

  vcConj(vec_len,cA,cB1);
