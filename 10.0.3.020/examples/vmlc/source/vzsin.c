...
int main()
{
  ...
  for(i=0;i<vec_len;i++) {
    zA[i].real=(double)(__DSIN_BEG/1000+((__DSIN_END/1000-__DSIN_BEG/1000)*i)/vec_len);
    zA[i].imag=(double)(__DSIN_END/1000-((__DSIN_END/1000-__DSIN_BEG/1000)*i)/vec_len);
    zB1[i].real=0.0;
    zB1[i].imag=0.0;
  }

  vzSin(vec_len,zA,zB1);
