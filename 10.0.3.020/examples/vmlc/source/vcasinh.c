...
int main()
{
  ...
  for(i=0;i<vec_len;i++) {
    cA[i].real=(float)(__SASINH_BEG+((__SASINH_END-__SASINH_BEG)*i)/vec_len);
    cA[i].imag=(float)(__SASINH_END-((__SASINH_END-__SASINH_BEG)*i)/vec_len);
    cB1[i].real=0.0;
    cB1[i].imag=0.0;
  }

  vcAsinh(vec_len,cA,cB1);
