...
int main()
{
  ...
  for(i=0;i<vec_len;i++) {
    cA[i].real=(float)(__SATANH_BEG+((__SATANH_END-__SATANH_BEG)*i)/vec_len);
    cA[i].imag=(float)(__SATANH_END-((__SATANH_END-__SATANH_BEG)*i)/vec_len);
    cB1[i].real=0.0;
    cB1[i].imag=0.0;
  }

  vcAtanh(vec_len,cA,cB1);
