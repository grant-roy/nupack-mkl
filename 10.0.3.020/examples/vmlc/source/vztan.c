...
int main()
{
  ...
  for(i=0;i<vec_len;i++) {
    zA[i].real=(double)(__DTAN_BEG/1000+((__DTAN_END/1000-__DTAN_BEG/1000)*i)/vec_len);
    zA[i].imag=(double)(__DTAN_END/1000-((__DTAN_END/1000-__DTAN_BEG/1000)*i)/vec_len);
    zB1[i].real=0.0;
    zB1[i].imag=0.0;
  }

  vzTan(vec_len,zA,zB1);
