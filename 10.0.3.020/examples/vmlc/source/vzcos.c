...
int main()
{
  ...
  for(i=0;i<vec_len;i++) {
    zA[i].real=(double)(__DCOS_BEG/1000+((__DCOS_END/1000-__DCOS_BEG/1000)*i)/vec_len);
    zA[i].imag=(double)(__DCOS_END/1000-((__DCOS_END/1000-__DCOS_BEG/1000)*i)/vec_len);
    zB1[i].real=0.0;
    zB1[i].imag=0.0;
  }

  vzCos(vec_len,zA,zB1);
