...
int main()
{
  ...
  for(i=0;i<vec_len;i++) {
    zA[i].real=(double)(__DATANH_BEG+((__DATANH_END-__DATANH_BEG)*i)/vec_len);
    zA[i].imag=(double)(__DATANH_END-((__DATANH_END-__DATANH_BEG)*i)/vec_len);
    zB1[i].real=0.0;
    zB1[i].imag=0.0;
  }

  vzAtanh(vec_len,zA,zB1);
