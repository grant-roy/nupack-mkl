...
int main()
{
  ...
  for(i=0;i<vec_len;i++) {
    cA[i].real=(float)(__SCOS_BEG/1000+((__SCOS_END/1000-__SCOS_BEG/1000)*i)/vec_len);
    cA[i].imag=(float)(__SCOS_END/1000-((__SCOS_END/1000-__SCOS_BEG/1000)*i)/vec_len);
    cB1[i].real=0.0;
    cB1[i].imag=0.0;
  }

  vcCos(vec_len,cA,cB1);
