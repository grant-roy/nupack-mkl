...
int main()
{
  ...
  for(i=0;i<vec_len;i++) {
    zA[i].real=(double)(__DLOG10_BEG+((__DLOG10_END-__DLOG10_BEG)*i)/vec_len);
    zA[i].imag=(double)(__DLOG10_END-((__DLOG10_END-__DLOG10_BEG)*i)/vec_len);
    zB1[i].real=0.0;
    zB1[i].imag=0.0;
  }

  vzLog10(vec_len,zA,zB1);
