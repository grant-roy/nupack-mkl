...
int main()
{
  ...
  for(i=0;i<vec_len;i++) {
    zA[i].real=(double)(__DASINH_BEG+((__DASINH_END-__DASINH_BEG)*i)/vec_len);
    zA[i].imag=(double)(__DASINH_END-((__DASINH_END-__DASINH_BEG)*i)/vec_len);
    zB1[i].real=0.0;
    zB1[i].imag=0.0;
  }

  vzAsinh(vec_len,zA,zB1);
