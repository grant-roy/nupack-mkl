...
int main()
{
  ...
  for(i=0;i<vec_len;i++) {
    cA[i].real=(float)(__SLOG10_BEG+((__SLOG10_END-__SLOG10_BEG)*i)/vec_len);
    cA[i].imag=(float)(__SLOG10_END-((__SLOG10_END-__SLOG10_BEG)*i)/vec_len);
    cB1[i].real=0.0;
    cB1[i].imag=0.0;
  }

  vcLog10(vec_len,cA,cB1);
