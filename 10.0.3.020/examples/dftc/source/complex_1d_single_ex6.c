...
int main(int argc, char *argv[])  /* COMPLEX_1D_SINGLE_EX6 */
{
    ...
    */
    ...
    if(LEGEND_PRINT) {
        printf(" \n\n COMPLEX_1D_SINGLE_EX6                                     \n");
        printf(" Forward-Backward multiple column 1D complex transform          \n");
    ...
    */
    ...
    init_multiple_columns_c(x_in, n, multiple, first_index, N_MAX);

    cblas_ccopy(M_MAX*N_MAX, x_in, 1, x_exp, 1);

    if(ADVANCED_DATA_PRINT){
        printf("\n INPUT  X (for multiple=3)\n\n");
        print_three_columns_c(x_in, n, first_index, N_MAX);
    }
    ...
    */
    ...
    if(ADVANCED_DATA_PRINT){
        ...
        print_three_columns_c(x_out, n, first_index, N_MAX);
    }
