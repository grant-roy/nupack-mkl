...
!       for float precision data inplace
...
int main(int argc, char *argv[])  /* REAL_2D_PERM_SINGLE_EX7 */
{
    ...
    */
    ...
    if(LEGEND_PRINT) {
        printf(" \n\n REAL_2D_PERM_SINGLE_EX7                \n");
        printf(" Forward-Backward 2D real transform for float precision data\n\n");
        ...
        printf(" DFTI_PACKED_FORMAT  = DFTI_PERM_FORMAT      \n");
    ...
    */
    ...
    /*
    /   Create Dfti descriptor for 2D float precision  transform
    */
