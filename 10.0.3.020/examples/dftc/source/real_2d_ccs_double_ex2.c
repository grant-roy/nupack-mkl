...
int main(int argc, char *argv[])  /* REAL_2D_CCS_DOUBLE_EX2 */
{
    double  x_in [M_MAX][N_MAX];
    double  x_out[M_MAX+2][N_MAX+2];
    ...
    */
    ...
    zero_init_d(x_out,(M_MAX+2)*(N_MAX+2));
    ...
    */
    ...
    if(ADVANCED_DATA_PRINT){
        ...
        print_three_first_and_three_last_columns_d(x_out, m+2, n+2, strides_out);
    }
