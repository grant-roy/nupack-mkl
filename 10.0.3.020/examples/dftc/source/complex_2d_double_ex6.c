...
int main(int argc, char *argv[])  /* COMPLEX_2D_DOUBLE_EX6 */
{
    ...
    */
    ...
    for(i=0; i< multiple; i++){
        init_multiple_2d_columns_z(&x_in[0][i][0], m, n, strides_in);
    }
    ...
    if(ADVANCED_DATA_PRINT){
        ...
        for(i=0; i< multiple; i++) {
            printf("\n Transform Serial=%d \n", i);
            print_three_2d_columns_z(&x_in[0][i][0], m, strides_in);
        }
    }
    ...
    */
    ...
    if(ADVANCED_DATA_PRINT){
        ...
        for(i=0; i< multiple; i++) {
            printf("\n Transform Serial=%d \n", i);
            print_three_2d_columns_z(&x_out[0][i][0], m, strides_out);
        }
    }
