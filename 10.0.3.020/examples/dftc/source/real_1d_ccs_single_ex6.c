...
int main(int argc, char *argv[])  /* REAL_1D_CCS_SINGLE_EX6 */
{
    float   x_in [M_MAX*N_MAX];
    float   x_out[(M_MAX+2)*N_MAX];
    ...
    */
    ...
    zero_init_s(x_out, (M_MAX+2)*N_MAX);
    ...
    */
    ...
    if(ADVANCED_DATA_PRINT){
        ...
        print_three_columns_s(x_out, n+2, dist_out, strides_out);
    }
