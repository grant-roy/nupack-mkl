...
int main(int argc, char *argv[])  /* REAL_1D_CCS_SINGLE_EX2 */
{
    float*  x_in;
    float*  x_out;
    float*  x_exp;
    ...
    */
    ...
    x_out = (float*)malloc((n+2)*sizeof(float));
