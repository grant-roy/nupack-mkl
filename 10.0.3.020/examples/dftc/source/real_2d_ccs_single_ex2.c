...
int main(int argc, char *argv[])  /* REAL_2D_CCS_SINGLE_EX2 */
{
    float   x_in [M_MAX][N_MAX];
    float   x_out[M_MAX+2][N_MAX+2];
    ...
    */
    ...
    strides_out[0]= 0;
    strides_out[1]= N_MAX+2;
    strides_out[2]= 1;

    if(LEGEND_PRINT) {
        printf(" \n\n REAL_2D_CCS_SINGLE_EX2                \n");
    ...
    */
    ...
    zero_init_s(x_out,(M_MAX+2)*(N_MAX+2));
    ...
    */
    ...
    if(ADVANCED_DATA_PRINT){
        ...
        print_three_first_and_three_last_columns_s(x_out, m+2, n+2, strides_out);
    }
