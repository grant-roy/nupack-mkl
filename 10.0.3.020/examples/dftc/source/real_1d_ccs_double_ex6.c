...
int main(int argc, char *argv[])  /* REAL_1D_CCS_DOUBLE_EX6 */
{
    double  x_in [M_MAX*N_MAX];
    double  x_out[(M_MAX+2)*N_MAX];
    ...
    */
    ...
    zero_init_d(x_out, (M_MAX+2)*N_MAX);
    ...
    */
    ...
    if(ADVANCED_DATA_PRINT){
        ...
        print_three_columns_d(x_out, n+2, dist_out, strides_out);
    }
