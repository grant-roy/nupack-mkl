...
int main(int argc, char *argv[])  /* REAL_3D_CCE_DOUBLE_EX4 */
{
    double  x_in [M_MAX][N_MAX][K_MAX];
    mkl_double_complex  x_out[M_MAX][N_MAX][K_MAX/2+1];
    ...
    */
    ...
    strides_in[1]   = step_in_m * N_MAX*(K_MAX/2+1);
    strides_in[2]   = step_in_n * K_MAX/2+1;
    ...
    strides_out[1]  = step_out_m * N_MAX*(K_MAX/2+1);
    strides_out[2]  = step_out_n * K_MAX/2+1;
    ...
    */
    ...
    zero_init_z(x_out, M_MAX*N_MAX*(K_MAX/2+1));
    ...
    /*
    /   Create Dfti descriptor for 3D double precision  transform
    */
