...
int main(int argc, char *argv[])  /* REAL_2D_PERM_DOUBLE_EX2 */
{
    double  x_in [M_MAX][N_MAX];
    double  x_out[M_MAX][N_MAX];
    ...
    */
    one_init_d(x_in, M_MAX*N_MAX);
    one_init_d(x_out,M_MAX*N_MAX);
    ...
    if(ADVANCED_DATA_PRINT){
        ...
        print_three_first_and_three_last_columns_d(x_in, m, n, strides_in);
    }
    ...
    */
    ...
    if(ADVANCED_DATA_PRINT){
        ...
        print_three_first_and_three_last_columns_d(x_out, m, n, strides_out);
    }
