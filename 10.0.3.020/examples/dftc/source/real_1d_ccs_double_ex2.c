...
int main(int argc, char *argv[])  /* REAL_1D_CCS_DOUBLE_EX2 */
{
    double *  x_in;
    double *  x_out;
    double *  x_exp;
    ...
    */
    ...
    x_out = (double *)malloc((n+2)*sizeof(double ));
