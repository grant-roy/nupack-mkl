...
int main(int argc, char *argv[])  /* REAL_2D_CCE_DOUBLE_EX4 */
{
    ...
    */
    ...
    strides_out[1] = K_MAX/2+1;
    strides_out[2] = 1;

    if(LEGEND_PRINT) {
        printf(" \n\n REAL_2D_CCE_DOUBLE_EX4                \n");
    ...
    */
    ...
    if(ADVANCED_DATA_PRINT){
        ...
        for(i=0; i< multiple; i++) {
            printf("\n Transform Serial=%d \n", i);
            print_three_2d_columns_d(&x_in[i][0][0], m, n, strides_in);
        }
    }
