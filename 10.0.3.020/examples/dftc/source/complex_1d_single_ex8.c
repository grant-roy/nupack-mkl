...
!
!       Forward complex 1D transform for single precision data not inplace.
!
!*******************************************************************************
...
!           DFTI_FORWARD_SCALE = 1.0/(float)n       (default=1.0)
!
...
int main(int argc, char *argv[])  /* COMPLEX_1D_SINGLE_EX8 */
{
    ...
    */
    ...
    if(LEGEND_PRINT) {
        printf(" COMPLEX_1D_SINGLE_EX8                                  \n");
        printf(" Forward 1D complex transform for single precision data \n");
        ...
        printf(" DFTI_FORWARD_SCALE = 1.0/(float)n                      \n\n");
    }
    ...
    */
    ...
    x_out = (mkl_float_complex*)malloc(2*n*sizeof(float));
    x_exp = (mkl_float_complex*)malloc(2*n*sizeof(float));

    /*
    /   init Sinusoid tone and expected uotput result
    */
    init_forward_tone_and_expected_result_c(x_in, x_exp, n);
