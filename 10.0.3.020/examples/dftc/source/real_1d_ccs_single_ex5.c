...
!       Real-to-complex and complex-to-real multiple columns transform inplace
...
int main(int argc, char *argv[])  /* REAL_1D_CCS_SINGLE_EX5 */
{
    float   x_in [(M_MAX+2)*N_MAX];
    ...
    */
    zero_init_s(x_in, (M_MAX+2)*N_MAX);
