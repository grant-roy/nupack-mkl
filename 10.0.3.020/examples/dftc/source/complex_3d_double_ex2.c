...
!           DFTI_OUTPUT_STRIDES = {0, K_MAX*N_MAX, K_MAX, 1}    (default = {0,n*k,k,1})
!
...
int main(int argc, char *argv[])  /* COMPLEX_3D_DOUBLE_EX2 */
{
    ...
    */
    ...
    strides_out[0]  = 0;
    strides_out[1]  = K_MAX*N_MAX;
    strides_out[2]  = K_MAX;
    strides_out[3]  = 1;

    if(LEGEND_PRINT) {
        printf(" \n\n COMPLEX_3D_DOUBLE_EX2  \n");
