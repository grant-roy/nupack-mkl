...
!
!       Backward complex 1D transform for double precision data not inplace.
!
!*******************************************************************************
...
int main(int argc, char *argv[])  /* COMPLEX_1D_DOUBLE_EX10 */
{
    ...
    */
    ...
    if(LEGEND_PRINT) {
        printf(" \n\n COMPLEX_1D_DOUBLE_EX10                            \n");
        printf(" Backward 1D complex transform for double precision data\n");
    ...
    */
    ...
    x_out = (mkl_double_complex*)malloc(2*n*sizeof(double));
    x_exp = (mkl_double_complex*)malloc(2*n*sizeof(double));

    /*
    /   init Sinusoid tone and expected uotput result
    */
    init_backward_tone_and_expected_result_z(x_in, x_exp, n);
    ...
    */
    ...
    if(ADVANCED_DATA_PRINT){
        printf(" Backward result vector X_OUT \n");
        print_vector_z( x_out, n);
    }
