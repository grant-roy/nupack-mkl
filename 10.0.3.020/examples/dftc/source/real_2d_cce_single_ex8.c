...
int main(int argc, char *argv[])  /* REAL_2D_CCE_SINGLE_EX8 */
{
    float  x_in [M_MAX][N_MAX][K_MAX];
    mkl_float_complex  x_out[M_MAX][N_MAX/2+1][K_MAX];
    ...
    */
    ...
    zero_init_c(x_out, M_MAX*(N_MAX/2+1)*K_MAX);
