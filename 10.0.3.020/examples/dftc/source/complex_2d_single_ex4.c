...
!
!       Complex-to-complex multiple 2D transform for single precision data
...
int main(int argc, char *argv[])  /* COMPLEX_2D_SINGLE_EX3 */
{
    ...
    */
    ...
    for(i=0; i< multiple; i++){
        init_multiple_2d_columns_c(&x_in[i][0][0], m, n, strides_in);
    }
    ...
    if(ADVANCED_DATA_PRINT){
        ...
        for(i=0; i< multiple; i++) {
            printf("\n Transform Serial=%d \n", i);
            print_three_2d_columns_c(&x_in[i][0][0], m, strides_in);
        }
    }
    ...
    */
    ...
    if(ADVANCED_DATA_PRINT){
        ...
        for(i=0; i< multiple; i++) {
            printf("\n Transform Serial=%d \n", i);
            print_three_2d_columns_c(&x_out[i][0][0], m, strides_out);
        }
    }
