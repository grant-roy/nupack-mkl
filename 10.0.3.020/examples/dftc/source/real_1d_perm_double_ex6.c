...
!           DFTI_INPUT_DISTANCE       = 1                   (obligatory,
...
int main(int argc, char *argv[])  /* REAL_1D_PERM_DOUBLE_EX6 */
{
    ...
    */
    ...
    zero_init_d(x_out, M_MAX*N_MAX);

    init_multiple_columns_d(x_in, n, multiple, dist_in, strides_in);

    cblas_dcopy(M_MAX*N_MAX, x_in, 1, x_exp, 1);
    ...
    */
    ...
    if(ADVANCED_DATA_PRINT){
        ...
        print_three_columns_d(x_out, n, dist_out, strides_out);
    }
