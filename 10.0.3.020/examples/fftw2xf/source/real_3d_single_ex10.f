...
!******************************************************************************/
      ...
      INTEGER SIZE,N,M,L,OUT_N,STATUS,IDIST,ODIST,ISTRIDE
...
!
      ...
      CALL RFFTWND_F77_CREATE_PLAN(FFTW_PLAN,RANK,DIM,
...
!
      ...
      CALL RFFTWND_F77_REAL_TO_COMPLEX(FFTW_PLAN,
...
!
      ...
      CALL RFFTWND_F77_COMPLEX_TO_REAL(FFTW_PLAN,
