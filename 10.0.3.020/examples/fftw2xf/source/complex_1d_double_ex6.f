...
!
      ...
      CALL FFTW_F77_CREATE_PLAN(FFTW_PLAN,N,FFTW_FORWARD,FFTW_ESTIMATE)

!
!     Compute Forward
!
      PRINT*,' Compute Forward'
      CALL FFTW_F77_THREADS_ONE(NTHREADS,FFTW_PLAN,IN,OUT)
...
!
      ...
      CALL FFTW_F77_CREATE_PLAN(FFTW_PLAN,N,FFTW_BACKWARD,FFTW_ESTIMATE)

!
!     Compute Backward
!
      PRINT*,' Compute Backward'
      CALL FFTW_F77_THREADS_ONE(NTHREADS,FFTW_PLAN,OUT,IN)
