...
!
!*******************************************************************************
!   function    : sfftw_plan_guru_dft - interface FFTW initialization function
...
void sfftw_plan_guru_dft(fftwf_plan* plan, int*rank, int* n, int* is, int* os,
...
fftw_iodim howmany_dims[1];
    ...
    *plan = fftwf_plan_guru_dft(*rank, dims, *howmany_rank, howmany_dims,
			 in, out, *sign, *flags);
    return;
}
