...
!
!*******************************************************************************
!   function    : fftwf_plan_dft_c2r_2d - wrapper for interface FFTW function
!   Content     :
!   output data :
!*******************************************************************************
*/
...
fftwf_plan fftwf_plan_dft_c2r_2d(int nx, int ny, fftwf_complex *in, float *out,
								 unsigned flags) {
    MKL_LONG Status;
    MKL_LONG nn[2];
    ...
    Status = DftiCreateDescriptor(&(fftw_desc_mkl->mkl_desc), DFTI_SINGLE, DFTI_REAL, 2, nn);
