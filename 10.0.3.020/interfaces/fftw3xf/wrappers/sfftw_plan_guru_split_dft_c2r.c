...
!
!*******************************************************************************
!   function    : sfftw_plan_guru_split_dft_c2r - wrapper for interface FFTW function
...
void sfftwf_plan_guru_split_dft_c2r(fftwf_plan* plan, int* rank, int* n, int* is, int* os,
