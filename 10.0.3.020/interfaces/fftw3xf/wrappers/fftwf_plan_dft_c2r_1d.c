...
!
!*******************************************************************************
!   function    : fftwf_plan_dft_c2r_1d - interface FFTW initialization function
...
fftwf_plan fftwf_plan_dft_c2r_1d(int n, fftwf_complex *in, float *out, unsigned flags) {
    ...
    Status = DftiCreateDescriptor(&(fftw_desc_mkl->mkl_desc), DFTI_SINGLE, DFTI_REAL, 1, (MKL_LONG)n);
