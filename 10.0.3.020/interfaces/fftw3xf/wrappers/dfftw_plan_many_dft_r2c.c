...
!
!*******************************************************************************
!   function    : dfftw_plan_many_dft_r2c - interface FFTW initialization function
...
void dfftw_plan_many_dft_r2c(fftw_plan* plan, int* rank, const int* n, int* howmany,
...
int i;
    ...
    *plan = fftw_plan_many_dft_r2c(*rank, nn, *howmany, in, inem, *istride, *idist,
