...
!
!*******************************************************************************
!   function    : sfftw_plan_dft_3d - interface FFTW initialization function
...
void sfftw_plan_dft_3d(fftwf_plan* plan, int* nx, int* ny, int* nz, fftwf_complex *in,
						   fftwf_complex *out, int* sign, unsigned* flags) {

    *plan = fftwf_plan_dft_3d(*nz, *ny, *nx, in, out, *sign, *flags);
    return;
}
