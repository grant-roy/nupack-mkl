...
!
!*******************************************************************************
!   function    : sfftw_plan_dft_2d - interface FFTW initialization function
...
void sfftw_plan_dft_2d(fftwf_plan* plan, int* nx, int* ny, fftwf_complex *in,
							 fftwf_complex *out, int* sign, unsigned* flags) {
    *plan = fftwf_plan_dft_2d(*ny, *nx, in, out, *sign, *flags);
    return;
}
