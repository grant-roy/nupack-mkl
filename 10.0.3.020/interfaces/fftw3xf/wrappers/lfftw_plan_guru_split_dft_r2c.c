...
!
!*******************************************************************************
!   function    : lfftw_plan_guru_split_dft_r2c - wrapper for interface FFTW function
...
void lfftw_plan_guru_split_dft_r2c(fftwl_plan* plan, int* rank, int* n, int* is, int* os,
