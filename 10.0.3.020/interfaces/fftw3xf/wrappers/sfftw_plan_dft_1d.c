...
!
!*******************************************************************************
!   function    : sfftw_plan_dft_1d - interface FFTW initialization function
...
void sfftw_plan_dft_1d(fftwf_plan* plan, int* n, fftwf_complex *in, fftwf_complex *out, int* sign, unsigned* flags) {
