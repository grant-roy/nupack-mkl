...
!*******************************************************************************
!*******************************************************************************
!   function    : fftwf_plan_r2r_1d - wrapper for interface FFTW function
                  ...
                  unsigned flags)
{
    ...
    case FFTW_RODFT00:
        {         /*--------------------------------------------------------------------------------*/
            ...
            n_1 = nn + 1 ;
            spar=(float*)malloc((3*n_1/2+2)*sizeof(float));
            ipar=(int*)malloc((128)*sizeof(int));
            s_init_trig_transform(&n_1,&tt_type,ipar,spar,&ir);
            if (ir != 0)
            {
                printf("\n============================================================================\n");
            ...
            s_commit_trig_transform(out,&handle,ipar,spar,&ir);
            if (ir != 0)
            {
                printf("\n============================================================================\n");
    ...
    case FFTW_REDFT11:
        {
            ...
            n_1 = nn;
            spar=(float*)malloc((5*n_1/2+2)*sizeof(float));
            ipar=(int*)malloc((128)*sizeof(int));
            s_init_trig_transform(&n_1,&tt_type,ipar,spar,&ir);
            if (ir != 0)
            {
