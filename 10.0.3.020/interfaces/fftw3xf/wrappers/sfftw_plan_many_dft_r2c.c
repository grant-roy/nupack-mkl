...
!
!*******************************************************************************
!   function    : sfftw_plan_many_dft_r2c - interface FFTW initialization function
...
void sfftw_plan_many_dft_r2c(fftwf_plan* plan, int* rank, const int* n, int* howmany,
...
int i;
    ...
    *plan = fftwf_plan_many_dft_r2c(*rank, nn, *howmany, in, inem, *istride, *idist,
