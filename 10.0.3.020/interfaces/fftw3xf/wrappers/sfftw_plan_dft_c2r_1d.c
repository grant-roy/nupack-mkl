...
!
!*******************************************************************************
!   function    : sfftw_plan_dft_c2r_1d - interface FFTW initialization function
...
void sfftw_plan_dft_c2r_1d(fftwf_plan* plan, int* n, fftwf_complex *in, float *out, unsigned* flags) {
