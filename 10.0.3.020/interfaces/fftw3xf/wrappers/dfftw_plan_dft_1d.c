...
!
!*******************************************************************************
!   function    : dfftw_plan_dft_1d - interface FFTW initialization function
...
void dfftw_plan_dft_1d(fftw_plan* plan, int* n, fftw_complex *in, fftw_complex *out, int* sign, unsigned* flags) {
