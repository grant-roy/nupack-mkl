...
!
!*******************************************************************************
!   function    : sfftw_plan_dft_r2c_1d - interface FFTW initialization function
...
void sfftw_plan_dft_r2c_1d(fftwf_plan* plan, int* n, float *in, fftwf_complex *out, unsigned* flags) {
