...
!
!*******************************************************************************
!   function    : dfftw_plan_dft_c2r_1d - interface FFTW initialization function
...
void dfftw_plan_dft_c2r_1d(fftw_plan* plan, int* n, fftw_complex *in, double *out, unsigned* flags) {
