...
!
!*******************************************************************************
!   function    : sfftw_plan_guru_split_dft_r2c - wrapper for interface FFTW function
...
void sfftw_plan_guru_split_dft_r2c(fftwf_plan* plan, int* rank, int* n, int* is, int* os,
