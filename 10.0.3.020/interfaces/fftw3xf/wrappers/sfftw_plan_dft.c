...
!
!*******************************************************************************
!   function    : sfftw_plan_dft - interface FFTW initialization function
...
void sfftw_plan_dft(fftwf_plan* plan, int* rank, const int* n, fftwf_complex *in,
...
int i;
    ...
    *plan = fftwf_plan_dft(*rank, nn, in, out, *sign, *flags);
    return;
}
