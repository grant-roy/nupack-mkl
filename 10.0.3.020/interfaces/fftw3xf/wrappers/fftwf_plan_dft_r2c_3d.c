...
!
!*******************************************************************************
!   function    : fftwf_plan_dft_r2c_3d - wrapper for interface FFTW function
...
fftwf_plan fftwf_plan_dft_r2c_3d(int nx, int ny, int nz, float *in,
    ...
    Status = DftiCreateDescriptor(&(fftw_desc_mkl->mkl_desc), DFTI_SINGLE, DFTI_REAL, 3, nn);
