...
!
!*******************************************************************************
!   function    : fftw_plan_dft_1d - interface FFTW initialization function
...
fftw_plan fftw_plan_dft_1d(int n, fftw_complex *in, fftw_complex *out, int sign, unsigned flags) {
    ...
    Status = DftiCreateDescriptor(&(fftw_desc_mkl->mkl_desc), DFTI_DOUBLE, DFTI_COMPLEX, 1, (MKL_LONG)n);
