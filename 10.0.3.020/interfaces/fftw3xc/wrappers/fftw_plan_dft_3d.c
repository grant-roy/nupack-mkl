...
!
!*******************************************************************************
!   function    : fftw_plan_dft_3d - interface FFTW initialization function
...
fftw_plan fftw_plan_dft_3d(int nx, int ny, int nz, fftw_complex *in,
    ...
    Status = DftiCreateDescriptor(&(fftw_desc_mkl->mkl_desc), DFTI_DOUBLE, DFTI_COMPLEX, 3, n);
