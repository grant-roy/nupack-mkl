...
!
!*******************************************************************************
!   function    : fftwnd_threads_one - interface FFTW initialization function
...
void fftwnd_threads_one(int nthreads, fftwnd_plan plan, fftw_complex* in, fftw_complex* out) {
