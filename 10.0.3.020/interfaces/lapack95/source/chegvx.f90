...
PURE SUBROUTINE CHEGVX_MKL95(A,B,W,ITYPE,UPLO,Z,VL,VU,IL,IU,M,IFAIL,    &
    ...
    ! <<< Use statements >>>
    USE MKL77_LAPACK, ONLY: MKL77_HEGVX, MKL77_XERBLA
    ! <<< Implicit statement >>>
    IMPLICIT NONE
    ! <<< Kind parameter >>>
    ...
    LWORK = -1
    CALL MKL77_HEGVX(O_ITYPE,JOBZ,RANGE,O_UPLO,N,A,LDA,B,LDB,O_VL,O_VU, &
    ...
    IF(L_STAT_ALLOC==0) THEN
        CALL MKL77_HEGVX(O_ITYPE,JOBZ,RANGE,O_UPLO,N,A,LDA,B,LDB,O_VL,  &
