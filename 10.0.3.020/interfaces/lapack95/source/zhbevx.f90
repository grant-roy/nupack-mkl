...
PURE SUBROUTINE ZHBEVX_MKL95(A,W,UPLO,Z,VL,VU,IL,IU,M,IFAIL,Q,ABSTOL,   &
     &                                                             INFO)
    ! MKL Fortran77 call:
    ! ZHBEVX(JOBZ,RANGE,UPLO,N,KD,A,LDA,Q,LDQ,VL,VU,IL,IU,ABSTOL,M,W,Z,
    !   LDZ,WORK,RWORK,IWORK,IFAIL,INFO)
    ! <<< Use statements >>>
    USE MKL77_LAPACK, ONLY: MKL77_HBEVX, MKL77_XERBLA
    ! <<< Implicit statement >>>
    IMPLICIT NONE
    ! <<< Kind parameter >>>
    ...
    IF(L_STAT_ALLOC==0) THEN
        CALL MKL77_HBEVX(JOBZ,RANGE,O_UPLO,N,KD,A,LDA,O_Q,LDQ,O_VL,O_VU,&
