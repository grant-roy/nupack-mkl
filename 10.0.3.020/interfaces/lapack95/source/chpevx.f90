...
PURE SUBROUTINE CHPEVX_MKL95(A,W,UPLO,Z,VL,VU,IL,IU,M,IFAIL,ABSTOL,INFO)
    ! MKL Fortran77 call:
    ! CHPEVX(JOBZ,RANGE,UPLO,N,A,VL,VU,IL,IU,ABSTOL,M,W,Z,LDZ,WORK,
    !   RWORK,IWORK,IFAIL,INFO)
    ! <<< Use statements >>>
    USE MKL77_LAPACK, ONLY: MKL77_HPEVX, MKL77_XERBLA
    ! <<< Implicit statement >>>
    IMPLICIT NONE
    ! <<< Kind parameter >>>
    ...
    IF(L_STAT_ALLOC==0) THEN
        CALL MKL77_HPEVX(JOBZ,RANGE,O_UPLO,N,A,O_VL,O_VU,O_IL,O_IU,     &
