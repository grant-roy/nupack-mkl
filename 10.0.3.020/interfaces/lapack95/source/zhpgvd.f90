...
PURE SUBROUTINE ZHPGVD_MKL95(A,B,W,ITYPE,UPLO,Z,INFO)
    ...
    !   IWORK,LIWORK,INFO)
    ! <<< Use statements >>>
    USE MKL77_LAPACK, ONLY: MKL77_HPGVD, MKL77_XERBLA
    ! <<< Implicit statement >>>
    IMPLICIT NONE
    ! <<< Kind parameter >>>
    ...
    LRWORK = -1
    LWORK = -1
    CALL MKL77_HPGVD(O_ITYPE,JOBZ,O_UPLO,N,A,B,W,O_Z,LDZ,S_WORK,LWORK,  &
    ...
    IF(L_STAT_ALLOC==0) THEN
        CALL MKL77_HPGVD(O_ITYPE,JOBZ,O_UPLO,N,A,B,W,O_Z,LDZ,WORK,LWORK,&
