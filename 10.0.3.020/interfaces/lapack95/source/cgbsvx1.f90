...
PURE SUBROUTINE CGBSVX1_MKL95(A,B,X,KL,AF,IPIV,FACT,TRANS,EQUED,R,C,    &
    ...
    ! MKL Fortran77 call:
    ! CGBSVX(FACT,TRANS,N,KL,KU,NRHS,A,LDA,AF,LDAF,IPIV,EQUED,R,C,B,LDB,
    !   X,LDX,RCOND,FERR,BERR,WORK,RWORK,INFO)
    ! <<< Use statements >>>
    USE MKL77_LAPACK1, ONLY: MKL77_GBSVX
    ...
    IF(L_STAT_ALLOC==0) THEN
     ...
     &   O_IPIV,O_EQUED,O_R,O_C,B,LDB,X,LDX,O_RCOND,R_FERR,R_BERR,WORK, &
     &                                                     RWORK,O_INFO)
    ELSE; O_INFO = -1000
    ENDIF
